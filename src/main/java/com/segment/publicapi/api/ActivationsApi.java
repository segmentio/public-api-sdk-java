...
import com.segment.publicapi.models.BatchQueryActivationsForSpace200Response;
import com.segment.publicapi.models.BatchQueryActivationsForSpaceAlphaInput;
...
public class ActivationsApi {
    ...
    /**
     * Build call for batchQueryActivationsForSpace
     *
     * @param spaceId (required)
     * @param batchQueryActivationsForSpaceAlphaInput (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * </table>
     */
    public okhttp3.Call batchQueryActivationsForSpaceCall(
            String spaceId,
        ...
        Object localVarPostBody = batchQueryActivationsForSpaceAlphaInput;

        // create path and map variables
        String localVarPath =
                "/spaces/{spaceId}/activations/batch"
                        .replace(
                                "{" + "spaceId" + "}",
                                localVarApiClient.escapeString(spaceId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call batchQueryActivationsForSpaceValidateBeforeCall(
            String spaceId,
            BatchQueryActivationsForSpaceAlphaInput batchQueryActivationsForSpaceAlphaInput,
            final ApiCallback _callback)
            throws ApiException {
        ...
        if (spaceId == null) {
            throw new ApiException(
                    "Missing the required parameter 'spaceId' when calling"
                            + " batchQueryActivationsForSpace(Async)");
        }
        ...
        if (batchQueryActivationsForSpaceAlphaInput == null) {
            throw new ApiException(
                    "Missing the required parameter 'batchQueryActivationsForSpaceAlphaInput' when"
                            + " calling batchQueryActivationsForSpace(Async)");
        }

        return batchQueryActivationsForSpaceCall(
                spaceId, batchQueryActivationsForSpaceAlphaInput, _callback);
    }

    /**
     * Batch Query Activations for Space Lists Activations in bulk across many Audiences in one
     * call. Intended for bulk reads, for example pulling activation metadata for hundreds of
     * audiences on a schedule, so callers don&#39;t need one
     * &#x60;listActivationsFromAudience&#x60; call per audience. • In order to successfully call
     ...
     * @param spaceId (required)
     * @param batchQueryActivationsForSpaceAlphaInput (required)
     * @return BatchQueryActivationsForSpace200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public BatchQueryActivationsForSpace200Response batchQueryActivationsForSpace(
            String spaceId,
            BatchQueryActivationsForSpaceAlphaInput batchQueryActivationsForSpaceAlphaInput)
            throws ApiException {
        ApiResponse<BatchQueryActivationsForSpace200Response> localVarResp =
                batchQueryActivationsForSpaceWithHttpInfo(
                        spaceId, batchQueryActivationsForSpaceAlphaInput);
        return localVarResp.getData();
    }
     ...
     * @param spaceId (required)
     * @param batchQueryActivationsForSpaceAlphaInput (required)
     * @return ApiResponse&lt;BatchQueryActivationsForSpace200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public ApiResponse<BatchQueryActivationsForSpace200Response>
            batchQueryActivationsForSpaceWithHttpInfo(
                    String spaceId,
                    BatchQueryActivationsForSpaceAlphaInput batchQueryActivationsForSpaceAlphaInput)
                    throws ApiException {
        okhttp3.Call localVarCall =
                batchQueryActivationsForSpaceValidateBeforeCall(
                        spaceId, batchQueryActivationsForSpaceAlphaInput, null);
        Type localVarReturnType =
                new TypeToken<BatchQueryActivationsForSpace200Response>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Batch Query Activations for Space (asynchronously) Lists Activations in bulk across many
     * Audiences in one call. Intended for bulk reads, for example pulling activation metadata for
     * hundreds of audiences on a schedule, so callers don&#39;t need one
     * &#x60;listActivationsFromAudience&#x60; call per audience. • In order to successfully call
     * this endpoint, the specified Workspace needs to have the Audience feature enabled. Please
     * reach out to your customer success manager for more information. The rate limit for this
     * endpoint is 60 requests per minute, which is lower than the default due to access pattern
     ...
     * </table>
     */
    public okhttp3.Call batchQueryActivationsForSpaceAsync(
            String spaceId,
            BatchQueryActivationsForSpaceAlphaInput batchQueryActivationsForSpaceAlphaInput,
            final ApiCallback<BatchQueryActivationsForSpace200Response> _callback)
            throws ApiException {
