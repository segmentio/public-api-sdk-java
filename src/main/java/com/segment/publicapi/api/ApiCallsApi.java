...
public class ApiCallsApi {
    ...
    public GetDailyPerSourceAPICallsUsage200Response getDailyPerSourceAPICallsUsage(String period, PaginationInput pagination) throws ApiException {
        ApiResponse<GetDailyPerSourceAPICallsUsage200Response> localVarResp = getDailyPerSourceAPICallsUsageWithHttpInfo(period, pagination);
     ...
     */
    public ApiResponse<GetDailyPerSourceAPICallsUsage200Response> getDailyPerSourceAPICallsUsageWithHttpInfo(String period, PaginationInput pagination) throws ApiException {
        okhttp3.Call localVarCall = getDailyPerSourceAPICallsUsageValidateBeforeCall(period, pagination, null);
        Type localVarReturnType = new TypeToken<GetDailyPerSourceAPICallsUsage200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getDailyPerSourceAPICallsUsageAsync(String period, PaginationInput pagination, final ApiCallback<GetDailyPerSourceAPICallsUsage200Response> _callback) throws ApiException {
    ...
    public GetDailyWorkspaceAPICallsUsage200Response getDailyWorkspaceAPICallsUsage(String period, PaginationInput pagination) throws ApiException {
        ApiResponse<GetDailyWorkspaceAPICallsUsage200Response> localVarResp = getDailyWorkspaceAPICallsUsageWithHttpInfo(period, pagination);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetDailyWorkspaceAPICallsUsage200Response> getDailyWorkspaceAPICallsUsageWithHttpInfo(String period, PaginationInput pagination) throws ApiException {
        okhttp3.Call localVarCall = getDailyWorkspaceAPICallsUsageValidateBeforeCall(period, pagination, null);
        Type localVarReturnType = new TypeToken<GetDailyWorkspaceAPICallsUsage200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getDailyWorkspaceAPICallsUsageAsync(String period, PaginationInput pagination, final ApiCallback<GetDailyWorkspaceAPICallsUsage200Response> _callback) throws ApiException {
