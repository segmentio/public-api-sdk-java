...
import com.segment.publicapi.models.GetAudienceEcho200Response;
...
public class AudiencesApi {
    ...
    /**
     * Build call for getAudienceEcho
     *
     * @param spaceId (required)
     ...
     * </table>
     */
    public okhttp3.Call getAudienceEchoCall(
            String spaceId, String message, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAudienceEchoValidateBeforeCall(
            String spaceId, String message, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'spaceId' is set
        if (spaceId == null) {
            throw new ApiException(
                    "Missing the required parameter 'spaceId' when calling getAudienceEcho(Async)");
        }

        return getAudienceEchoCall(spaceId, message, _callback);
    }
     ...
     * limit of 1 requests per day per spaceId for testing rate limiting functionality.
     *
     * @param spaceId (required)
     * @param message Optional message to echo back. This parameter exists in alpha. (optional)
     ...
     * </table>
     */
    public GetAudienceEcho200Response getAudienceEcho(String spaceId, String message)
            throws ApiException {
        ApiResponse<GetAudienceEcho200Response> localVarResp =
                getAudienceEchoWithHttpInfo(spaceId, message);
        return localVarResp.getData();
    }
     ...
     * @param spaceId (required)
     * @param message Optional message to echo back. This parameter exists in alpha. (optional)
     * @return ApiResponse&lt;GetAudienceEcho200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public ApiResponse<GetAudienceEcho200Response> getAudienceEchoWithHttpInfo(
            String spaceId, String message) throws ApiException {
        okhttp3.Call localVarCall = getAudienceEchoValidateBeforeCall(spaceId, message, null);
        Type localVarReturnType = new TypeToken<GetAudienceEcho200Response>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * This endpoint has a rate limit of 1 requests per day per spaceId for testing rate limiting
     * functionality.
     *
     * @param spaceId (required)
     * @param message Optional message to echo back. This parameter exists in alpha. (optional)
     ...
     * </table>
     */
    public okhttp3.Call getAudienceEchoAsync(
            String spaceId, String message, final ApiCallback<GetAudienceEcho200Response> _callback)
            throws ApiException {

        okhttp3.Call localVarCall = getAudienceEchoValidateBeforeCall(spaceId, message, _callback);
        Type localVarReturnType = new TypeToken<GetAudienceEcho200Response>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
