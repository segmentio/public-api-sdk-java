...
public class AudiencesApi {
     ...
     * limit of 3 requests per day per spaceId for testing rate limiting functionality.
     *
     * @param spaceId (required)
     * @param message Optional message to echo back. This parameter exists in alpha. (optional)
     ...
     * This endpoint has a rate limit of 3 requests per day per spaceId for testing rate limiting
     * functionality.
     *
     * @param spaceId (required)
     * @param message Optional message to echo back. This parameter exists in alpha. (optional)
