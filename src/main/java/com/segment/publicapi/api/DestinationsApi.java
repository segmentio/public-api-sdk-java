...
public class DestinationsApi {
    ...
    /**
     * List Delivery Metrics Summary from Destination Get event delivery metrics summary from a
     * Destination. Based on the granularity, there are restrictions on the time range you can
     * query: **Minute Granularity**: - Max time range: 4 hours - Oldest possible start time: 48
     * hours in the past **Hour Granularity**: - Max Time range: 1 week - Oldest possible start
     * time: 10 days in the past **Day Granularity**: - Max time range: 60 days - Oldest possible
     * start time: 60 days in the past
     *
     * @param destinationId (required)
     * @param sourceId The id of the Source linked to the Destination. Config API note: analogous to
     *     &#x60;parent&#x60;. This parameter exists in beta. (required)
    ...
    /**
     * List Delivery Metrics Summary from Destination (asynchronously) Get event delivery metrics
     * summary from a Destination. Based on the granularity, there are restrictions on the time
     * range you can query: **Minute Granularity**: - Max time range: 4 hours - Oldest possible
     * start time: 48 hours in the past **Hour Granularity**: - Max Time range: 1 week - Oldest
     * possible start time: 10 days in the past **Day Granularity**: - Max time range: 60 days -
