...
public class TestingApi {
    ...
    public Echo200Response echo(String message, BigDecimal delay, Boolean triggerError, Boolean triggerMultipleErrors, Boolean triggerUnexpectedError, BigDecimal statusCode) throws ApiException {
        ApiResponse<Echo200Response> localVarResp = echoWithHttpInfo(message, delay, triggerError, triggerMultipleErrors, triggerUnexpectedError, statusCode);
     ...
     */
    public ApiResponse<Echo200Response> echoWithHttpInfo(String message, BigDecimal delay, Boolean triggerError, Boolean triggerMultipleErrors, Boolean triggerUnexpectedError, BigDecimal statusCode) throws ApiException {
     ...
     */
    public okhttp3.Call echoAsync(String message, BigDecimal delay, Boolean triggerError, Boolean triggerMultipleErrors, Boolean triggerUnexpectedError, BigDecimal statusCode, final ApiCallback<Echo200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = echoValidateBeforeCall(message, delay, triggerError, triggerMultipleErrors, triggerUnexpectedError, statusCode, _callback);
        Type localVarReturnType = new TypeToken<Echo200Response>(){}.getType();
