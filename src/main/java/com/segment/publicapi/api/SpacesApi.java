...
public class SpacesApi {
    ...
    private okhttp3.Call batchQueryMessagingSubscriptionsForSpaceValidateBeforeCall(
            String spaceId,
            BatchQueryMessagingSubscriptionsForSpaceAlphaInput
                    batchQueryMessagingSubscriptionsForSpaceAlphaInput,
            final ApiCallback _callback)
        ...
        if (batchQueryMessagingSubscriptionsForSpaceAlphaInput == null) {
            throw new ApiException(
                    "Missing the required parameter"
                            + " 'batchQueryMessagingSubscriptionsForSpaceAlphaInput' when calling"
                            + " batchQueryMessagingSubscriptionsForSpace(Async)");
        }
    ...
    public BatchQueryMessagingSubscriptionsForSpace200Response
            batchQueryMessagingSubscriptionsForSpace(
                    ...
                    BatchQueryMessagingSubscriptionsForSpaceAlphaInput
                            batchQueryMessagingSubscriptionsForSpaceAlphaInput)
                    throws ApiException {
        ApiResponse<BatchQueryMessagingSubscriptionsForSpace200Response> localVarResp =
                batchQueryMessagingSubscriptionsForSpaceWithHttpInfo(
     ...
     * </table>
     */
    public ApiResponse<BatchQueryMessagingSubscriptionsForSpace200Response>
            batchQueryMessagingSubscriptionsForSpaceWithHttpInfo(
                    String spaceId,
                    BatchQueryMessagingSubscriptionsForSpaceAlphaInput
                            batchQueryMessagingSubscriptionsForSpaceAlphaInput)
        ...
        okhttp3.Call localVarCall =
                batchQueryMessagingSubscriptionsForSpaceValidateBeforeCall(
                        spaceId, batchQueryMessagingSubscriptionsForSpaceAlphaInput, null);
        Type localVarReturnType =
                new TypeToken<BatchQueryMessagingSubscriptionsForSpace200Response>() {}.getType();
    ...
    public okhttp3.Call batchQueryMessagingSubscriptionsForSpaceAsync(
            ...
            BatchQueryMessagingSubscriptionsForSpaceAlphaInput
                    batchQueryMessagingSubscriptionsForSpaceAlphaInput,
            final ApiCallback<BatchQueryMessagingSubscriptionsForSpace200Response> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getSpaceCall(String spaceId, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
     ...
     * </table>
     */
    public ApiResponse<GetSpace200Response> getSpaceWithHttpInfo(String spaceId)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getSpaceAsync(
            String spaceId, final ApiCallback<GetSpace200Response> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call replaceMessagingSubscriptionsInSpacesCall(
            String spaceId,
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceMessagingSubscriptionsInSpacesValidateBeforeCall(
            String spaceId,
            ReplaceMessagingSubscriptionsInSpacesAlphaInput
                    replaceMessagingSubscriptionsInSpacesAlphaInput,
            final ApiCallback _callback)
        ...
        if (replaceMessagingSubscriptionsInSpacesAlphaInput == null) {
            throw new ApiException(
                    "Missing the required parameter"
                            + " 'replaceMessagingSubscriptionsInSpacesAlphaInput' when calling"
                            + " replaceMessagingSubscriptionsInSpaces(Async)");
        }
     ...
     * </table>
     */
    public ReplaceMessagingSubscriptionsInSpaces200Response replaceMessagingSubscriptionsInSpaces(
            String spaceId,
            ReplaceMessagingSubscriptionsInSpacesAlphaInput
                    replaceMessagingSubscriptionsInSpacesAlphaInput)
            throws ApiException {
        ApiResponse<ReplaceMessagingSubscriptionsInSpaces200Response> localVarResp =
                replaceMessagingSubscriptionsInSpacesWithHttpInfo(
                        spaceId, replaceMessagingSubscriptionsInSpacesAlphaInput);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<ReplaceMessagingSubscriptionsInSpaces200Response>
            replaceMessagingSubscriptionsInSpacesWithHttpInfo(
                    String spaceId,
                    ReplaceMessagingSubscriptionsInSpacesAlphaInput
                            replaceMessagingSubscriptionsInSpacesAlphaInput)
                    throws ApiException {
        okhttp3.Call localVarCall =
                replaceMessagingSubscriptionsInSpacesValidateBeforeCall(
                        spaceId, replaceMessagingSubscriptionsInSpacesAlphaInput, null);
        Type localVarReturnType =
                new TypeToken<ReplaceMessagingSubscriptionsInSpaces200Response>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * </table>
     */
    public okhttp3.Call replaceMessagingSubscriptionsInSpacesAsync(
            String spaceId,
            ReplaceMessagingSubscriptionsInSpacesAlphaInput
                    replaceMessagingSubscriptionsInSpacesAlphaInput,
            final ApiCallback<ReplaceMessagingSubscriptionsInSpaces200Response> _callback)
            throws ApiException {
