...
public class EventsApi {
     ...
     */
    public okhttp3.Call getEventsVolumeFromWorkspaceCall(String granularity, String startTime, String endTime, List<String> groupBy, List<String> sourceId, List<String> eventName, List<String> eventType, List<String> appVersion, PaginationInput pagination, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getEventsVolumeFromWorkspaceValidateBeforeCall(String granularity, String startTime, String endTime, List<String> groupBy, List<String> sourceId, List<String> eventName, List<String> eventType, List<String> appVersion, PaginationInput pagination, final ApiCallback _callback) throws ApiException {
     ...
     */
    public GetEventsVolumeFromWorkspace200Response getEventsVolumeFromWorkspace(String granularity, String startTime, String endTime, List<String> groupBy, List<String> sourceId, List<String> eventName, List<String> eventType, List<String> appVersion, PaginationInput pagination) throws ApiException {
        ApiResponse<GetEventsVolumeFromWorkspace200Response> localVarResp = getEventsVolumeFromWorkspaceWithHttpInfo(granularity, startTime, endTime, groupBy, sourceId, eventName, eventType, appVersion, pagination);
     ...
     */
    public ApiResponse<GetEventsVolumeFromWorkspace200Response> getEventsVolumeFromWorkspaceWithHttpInfo(String granularity, String startTime, String endTime, List<String> groupBy, List<String> sourceId, List<String> eventName, List<String> eventType, List<String> appVersion, PaginationInput pagination) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<GetEventsVolumeFromWorkspace200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getEventsVolumeFromWorkspaceAsync(String granularity, String startTime, String endTime, List<String> groupBy, List<String> sourceId, List<String> eventName, List<String> eventType, List<String> appVersion, PaginationInput pagination, final ApiCallback<GetEventsVolumeFromWorkspace200Response> _callback) throws ApiException {
