...
public class ComputedTraitsApi {
     ...
     * [audit trail](/tag/Audit-Trail). Note: The definition for a Computed Trait created using the
     * API is not editable through the Segment App. The rate limit for this endpoint is 10 requests
     ...
     * created using the API is not editable through the Segment App. The rate limit for this
