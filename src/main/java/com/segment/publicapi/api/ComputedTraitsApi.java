...
public class ComputedTraitsApi {
     ...
     * Note: The definition for a Computed Trait updated via the API is not editable via the Segment
     * App. The rate limit for this endpoint is 10 requests per minute, which is lower than the
