...
import com.segment.publicapi.models.GetReverseETLSyncStatusesBySubscriptionId200Response;
...
public class ReverseEtlApi {
    ...
    /**
     * Build call for getReverseETLSyncStatusesBySubscriptionId
     *
     * @param modelId (required)
     ...
     * </table>
     */
    public okhttp3.Call getReverseETLSyncStatusesBySubscriptionIdCall(
            String modelId,
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getReverseETLSyncStatusesBySubscriptionIdValidateBeforeCall(
            String modelId,
            String subscriptionId,
            PaginationInput pagination,
            final ApiCallback _callback)
        ...
        if (modelId == null) {
            throw new ApiException(
                    "Missing the required parameter 'modelId' when calling"
                            + " getReverseETLSyncStatusesBySubscriptionId(Async)");
        }
        ...
        return getReverseETLSyncStatusesBySubscriptionIdCall(
                modelId, subscriptionId, pagination, _callback);
    }

    /**
     * Get Reverse ETL Sync Statuses By Subscription Id Get the sync statuses for a Reverse ETL
     * mapping subscription. The sync status includes all detailed information about the sync - sync
     * status, duration, details about the extract and load phase if applicable, etc. The default
     * page count is 10, and then the next page can be fetched by passing the &#x60;cursor&#x60;
     * query parameter.
     *
     * @param modelId (required)
     * @param subscriptionId (required)
    ...
    public GetReverseETLSyncStatusesBySubscriptionId200Response
            getReverseETLSyncStatusesBySubscriptionId(
                    String modelId, String subscriptionId, PaginationInput pagination)
                    throws ApiException {
        ApiResponse<GetReverseETLSyncStatusesBySubscriptionId200Response> localVarResp =
                getReverseETLSyncStatusesBySubscriptionIdWithHttpInfo(
     ...
     * @param subscriptionId (required)
     * @param pagination Optional pagination params. This parameter exists in alpha. (optional)
     * @return ApiResponse&lt;GetReverseETLSyncStatusesBySubscriptionId200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public ApiResponse<GetReverseETLSyncStatusesBySubscriptionId200Response>
            getReverseETLSyncStatusesBySubscriptionIdWithHttpInfo(
                    String modelId, String subscriptionId, PaginationInput pagination)
                    throws ApiException {
        okhttp3.Call localVarCall =
                getReverseETLSyncStatusesBySubscriptionIdValidateBeforeCall(
                        modelId, subscriptionId, pagination, null);
        Type localVarReturnType =
                new TypeToken<GetReverseETLSyncStatusesBySubscriptionId200Response>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Reverse ETL Sync Statuses By Subscription Id (asynchronously) Get the sync statuses for a
    ...
    public okhttp3.Call getReverseETLSyncStatusesBySubscriptionIdAsync(
            ...
            String subscriptionId,
            PaginationInput pagination,
            final ApiCallback<GetReverseETLSyncStatusesBySubscriptionId200Response> _callback)
            throws ApiException {
