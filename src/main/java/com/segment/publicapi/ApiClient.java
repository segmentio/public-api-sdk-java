...
import com.segment.publicapi.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.segmentapis.com";
    ...
    public ApiClient() {
        ...
        authentications.put("token", new HttpBearerAuth("bearer"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/32.0.4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.segmentapis.com
    ...
    public List<Pair> parameterToPair(String name, Object value) {
        ...
        if (name == "pagination") {
            try {
                ...
                params.add(new Pair("pagination.count", paginationInput.getCount().toString()));
                String cursor = paginationInput.getCursor();
                if (cursor != null && cursor.trim() != "") {
                    params.add(new Pair("pagination.cursor", cursor));
                }
            } catch (Exception ex) {
            }
            return params;
     ...
     * @throws com.segment.publicapi.ApiException If fail to serialize the given object
     */
