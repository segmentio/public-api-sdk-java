...
import com.segment.publicapi.models.DisableEdgeFunctionsAlphaOutput;
...
public class DisableEdgeFunctions200Response {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DisableEdgeFunctions200Response disableEdgeFunctions200Response = (DisableEdgeFunctions200Response) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to DisableEdgeFunctions200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DisableEdgeFunctions200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableEdgeFunctions200Response is not found in the empty JSON string", DisableEdgeFunctions200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DisableEdgeFunctions200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableEdgeFunctions200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableEdgeFunctions200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableEdgeFunctions200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableEdgeFunctions200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableEdgeFunctions200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableEdgeFunctions200Response>() {
           @Override
           public void write(JsonWriter out, DisableEdgeFunctions200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableEdgeFunctions200Response read(JsonReader in) throws IOException {
