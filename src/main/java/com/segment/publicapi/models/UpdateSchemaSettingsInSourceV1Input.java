...
public class UpdateSchemaSettingsInSourceV1Input {
  ...
  **/
  ...
  public UpdateSchemaSettingsInSourceV1Input forwardingViolationsTo(String forwardingViolationsTo) {
  ...
  **/
  ...
  public UpdateSchemaSettingsInSourceV1Input forwardingBlockedEventsTo(String forwardingBlockedEventsTo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateSchemaSettingsInSourceV1Input updateSchemaSettingsInSourceV1Input = (UpdateSchemaSettingsInSourceV1Input) o;
    return Objects.equals(this.track, updateSchemaSettingsInSourceV1Input.track) &&
        ...
        Objects.equals(this.forwardingViolationsTo, updateSchemaSettingsInSourceV1Input.forwardingViolationsTo) &&
        Objects.equals(this.forwardingBlockedEventsTo, updateSchemaSettingsInSourceV1Input.forwardingBlockedEventsTo);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateSchemaSettingsInSourceV1Input
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateSchemaSettingsInSourceV1Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSchemaSettingsInSourceV1Input is not found in the empty JSON string", UpdateSchemaSettingsInSourceV1Input.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateSchemaSettingsInSourceV1Input.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSchemaSettingsInSourceV1Input` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSchemaSettingsInSourceV1Input.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSchemaSettingsInSourceV1Input' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSchemaSettingsInSourceV1Input> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSchemaSettingsInSourceV1Input.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSchemaSettingsInSourceV1Input>() {
           @Override
           public void write(JsonWriter out, UpdateSchemaSettingsInSourceV1Input value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSchemaSettingsInSourceV1Input read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateSchemaSettingsInSourceV1Input
  */
  public static UpdateSchemaSettingsInSourceV1Input fromJson(String jsonString) throws IOException {
