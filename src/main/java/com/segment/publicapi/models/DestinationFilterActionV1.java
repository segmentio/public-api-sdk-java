...
public class DestinationFilterActionV1 {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The kind of Transformation to apply to any matched properties.")
  ...
  **/
  ...
  @ApiModelProperty(value = "A dictionary of paths to object keys that this filter applies to.   The literal string '' represents the top level of the object.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A decimal between 0 and 1 used for 'sample' type events and influences the likelihood of sampling to occur.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The JSON path to a property within a payload object from which Segment generates a deterministic sampling rate.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DestinationFilterActionV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationFilterActionV1 is not found in the empty JSON string", DestinationFilterActionV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DestinationFilterActionV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationFilterActionV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinationFilterActionV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinationFilterActionV1' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<DestinationFilterActionV1>() {
           @Override
           public void write(JsonWriter out, DestinationFilterActionV1 value) throws IOException {
