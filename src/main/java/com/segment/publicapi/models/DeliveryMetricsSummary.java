...
public class DeliveryMetricsSummary {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceId, deliveryMetricsSummary.sourceId) &&
        Objects.equals(this.destinationMetadataId, deliveryMetricsSummary.destinationMetadataId) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeliveryMetricsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeliveryMetricsSummary is not found in the empty JSON string", DeliveryMetricsSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeliveryMetricsSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeliveryMetricsSummary` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeliveryMetricsSummary>() {
           @Override
           public void write(JsonWriter out, DeliveryMetricsSummary value) throws IOException {
