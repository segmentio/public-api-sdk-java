...
public class ListSourcesFromTrackingPlanV1Output {
    ...
    public ListSourcesFromTrackingPlanV1Output pagination(PaginationOutput pagination) {
    ...
    public boolean equals(Object o) {
        ...
        ListSourcesFromTrackingPlanV1Output listSourcesFromTrackingPlanV1Output =
                (ListSourcesFromTrackingPlanV1Output) o;
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ListSourcesFromTrackingPlanV1Output.openapiRequiredFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSourcesFromTrackingPlanV1Output.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSourcesFromTrackingPlanV1Output' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ListSourcesFromTrackingPlanV1Output> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ListSourcesFromTrackingPlanV1Output.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ListSourcesFromTrackingPlanV1Output>() {
                        @Override
                        public void write(JsonWriter out, ListSourcesFromTrackingPlanV1Output value)
                                throws IOException {
                        ...
                        @Override
                        public ListSourcesFromTrackingPlanV1Output read(JsonReader in)
                                throws IOException {
     ...
     *     ListSourcesFromTrackingPlanV1Output
     */
    public static ListSourcesFromTrackingPlanV1Output fromJson(String jsonString)
            throws IOException {
