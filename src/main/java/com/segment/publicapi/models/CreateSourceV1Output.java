...
import com.segment.publicapi.models.Source5;
 ...
 */
@ApiModel(description = "Returns a newly created Source.")

public class CreateSourceV1Output {
  public static final String SERIALIZED_NAME_SOURCE = "source";
  @SerializedName(SERIALIZED_NAME_SOURCE)
  private Source5 source;

  public CreateSourceV1Output() {
  }

  public CreateSourceV1Output source(Source5 source) {
  ...
  **/
  ...
  public Source5 getSource() {
    return source;
  }


  public void setSource(Source5 source) {
    this.source = source;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSourceV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateSourceV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSourceV1Output is not found in the empty JSON string", CreateSourceV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateSourceV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSourceV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateSourceV1Output>() {
           @Override
           public void write(JsonWriter out, CreateSourceV1Output value) throws IOException {
