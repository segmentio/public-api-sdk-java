...
public class SourceMetadata {
  ...
  public SourceMetadata id(String id) {
  ...
  **/
  ...
  public SourceMetadata name(String name) {
  ...
  **/
  ...
  public SourceMetadata slug(String slug) {
  ...
  **/
  ...
  public SourceMetadata description(String description) {
  ...
  **/
  ...
  public SourceMetadata logos(Logos1 logos) {
  ...
  **/
  ...
  public SourceMetadata options(List<IntegrationOptionBeta> options) {
    
    this.options = options;
    return this;
  }

  public SourceMetadata addOptionsItem(IntegrationOptionBeta optionsItem) {
  ...
  **/
  ...
  public SourceMetadata categories(List<String> categories) {
    
    this.categories = categories;
    return this;
  }

  public SourceMetadata addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public SourceMetadata isCloudEventSource(Boolean isCloudEventSource) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, sourceMetadata.id) &&
        Objects.equals(this.name, sourceMetadata.name) &&
        Objects.equals(this.slug, sourceMetadata.slug) &&
        Objects.equals(this.description, sourceMetadata.description) &&
        Objects.equals(this.logos, sourceMetadata.logos) &&
        Objects.equals(this.options, sourceMetadata.options) &&
        Objects.equals(this.categories, sourceMetadata.categories) &&
        Objects.equals(this.isCloudEventSource, sourceMetadata.isCloudEventSource);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SourceMetadata
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SourceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SourceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceMetadata` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SourceMetadata.openapiRequiredFields) {
