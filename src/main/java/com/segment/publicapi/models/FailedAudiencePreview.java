...
public class FailedAudiencePreview {
    ...
    public FailedAudiencePreview status(StatusEnum status) {
    ...
    public FailedAudiencePreview failureReason(String failureReason) {
    ...
    public FailedAudiencePreview id(String id) {
    ...
    public FailedAudiencePreview audienceType(AudienceTypeEnum audienceType) {
    ...
    public FailedAudiencePreview definition(AudienceDefinitionWithoutType definition) {
    ...
    public boolean equals(Object o) {
        ...
        FailedAudiencePreview failedAudiencePreview = (FailedAudiencePreview) o;
        return Objects.equals(this.status, failedAudiencePreview.status)
                && Objects.equals(this.failureReason, failedAudiencePreview.failureReason)
                && Objects.equals(this.id, failedAudiencePreview.id)
                && Objects.equals(this.audienceType, failedAudiencePreview.audienceType)
                && Objects.equals(this.definition, failedAudiencePreview.definition)
                && Objects.equals(this.options, failedAudiencePreview.options);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to FailedAudiencePreview
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FailedAudiencePreview.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FailedAudiencePreview is not found in"
                                        + " the empty JSON string",
                                FailedAudiencePreview.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FailedAudiencePreview.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `FailedAudiencePreview` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : FailedAudiencePreview.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FailedAudiencePreview.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FailedAudiencePreview' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FailedAudiencePreview> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(FailedAudiencePreview.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FailedAudiencePreview>() {
                        @Override
                        public void write(JsonWriter out, FailedAudiencePreview value)
                                throws IOException {
                        ...
                        @Override
                        public FailedAudiencePreview read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of FailedAudiencePreview given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FailedAudiencePreview
     * @throws IOException if the JSON string is invalid with respect to FailedAudiencePreview
     */
    public static FailedAudiencePreview fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FailedAudiencePreview.class);
    }

    /**
     * Convert an instance of FailedAudiencePreview to an JSON string
     *
     * @return JSON string
     */
