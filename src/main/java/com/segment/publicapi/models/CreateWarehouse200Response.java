...
import com.segment.publicapi.models.CreateWarehouseV1Output;
...
public class CreateWarehouse200Response {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateWarehouse200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateWarehouse200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWarehouse200Response is not found in the empty JSON string", CreateWarehouse200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateWarehouse200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWarehouse200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWarehouse200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWarehouse200Response' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateWarehouse200Response>() {
           @Override
           public void write(JsonWriter out, CreateWarehouse200Response value) throws IOException {
