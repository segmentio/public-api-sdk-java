...
public class Transformation {
    ...
    public Transformation addPropertyValueTransformationsItem(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, transformation.id)
                ...
                && Objects.equals(
                        ...
                        transformation.propertyValueTransformations);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Transformation.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Transformation is not found in the"
                                        + " empty JSON string",
                                Transformation.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Transformation` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<Transformation>() {
                        @Override
