...
public class GroupSourceSettingsV1 {
  ...
  **/
  ...
  public GroupSourceSettingsV1 commonEventOnViolations(CommonEventOnViolationsEnum commonEventOnViolations) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowUnplannedTraits, groupSourceSettingsV1.allowUnplannedTraits) &&
        Objects.equals(this.allowTraitsOnViolations, groupSourceSettingsV1.allowTraitsOnViolations) &&
        Objects.equals(this.commonEventOnViolations, groupSourceSettingsV1.commonEventOnViolations);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupSourceSettingsV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupSourceSettingsV1 is not found in the empty JSON string", GroupSourceSettingsV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GroupSourceSettingsV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupSourceSettingsV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupSourceSettingsV1>() {
           @Override
           public void write(JsonWriter out, GroupSourceSettingsV1 value) throws IOException {
