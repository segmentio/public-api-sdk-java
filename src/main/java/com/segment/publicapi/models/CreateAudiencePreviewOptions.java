...
public class CreateAudiencePreviewOptions {
    ...
    public CreateAudiencePreviewOptions() {}

    public CreateAudiencePreviewOptions filterByExternalIds(List<String> filterByExternalIds) {

        this.filterByExternalIds = filterByExternalIds;
        return this;
    }

    public CreateAudiencePreviewOptions addFilterByExternalIdsItem(String filterByExternalIdsItem) {
    ...
    public CreateAudiencePreviewOptions backfillEventDataDays(BigDecimal backfillEventDataDays) {
     ...
     * audience preview membership. If not specified, the default is set to the maximum event window
     * size, or 7 days if no window condition is defined. Note that this is applied on a best-effort
     * basis and may not always be applicable. In such cases, the response will not return a
     * backfillEventDataDays value, and all available data will be taken into account.
     *
    ...
    public boolean equals(Object o) {
        ...
        CreateAudiencePreviewOptions createAudiencePreviewOptions =
                (CreateAudiencePreviewOptions) o;
        return Objects.equals(
                        this.filterByExternalIds, createAudiencePreviewOptions.filterByExternalIds)
                && Objects.equals(
                        this.backfillEventDataDays,
                        createAudiencePreviewOptions.backfillEventDataDays);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateAudiencePreviewOptions.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateAudiencePreviewOptions is not"
                                        + " found in the empty JSON string",
                                CreateAudiencePreviewOptions.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CreateAudiencePreviewOptions.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `CreateAudiencePreviewOptions` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateAudiencePreviewOptions.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateAudiencePreviewOptions' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateAudiencePreviewOptions> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreateAudiencePreviewOptions.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreateAudiencePreviewOptions>() {
                        @Override
                        public void write(JsonWriter out, CreateAudiencePreviewOptions value)
                                throws IOException {
                        ...
                        @Override
                        public CreateAudiencePreviewOptions read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of CreateAudiencePreviewOptions given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreateAudiencePreviewOptions
     * @throws IOException if the JSON string is invalid with respect to
     *     CreateAudiencePreviewOptions
     */
    public static CreateAudiencePreviewOptions fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreateAudiencePreviewOptions.class);
    }

    /**
     * Convert an instance of CreateAudiencePreviewOptions to an JSON string
     *
     * @return JSON string
     */
