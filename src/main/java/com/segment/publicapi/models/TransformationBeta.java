...
public class TransformationBeta {
    ...
    public TransformationBeta propertyValueTransformations(
    ...
    public TransformationBeta addPropertyValueTransformationsItem(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, transformationBeta.id)
                ...
                && Objects.equals(
                        this.destinationMetadataId, transformationBeta.destinationMetadataId)
                ...
                && Objects.equals(
                        ...
                        transformationBeta.propertyValueTransformations);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TransformationBeta
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TransformationBeta.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `TransformationBeta` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<TransformationBeta>() {
                        @Override
                        public void write(JsonWriter out, TransformationBeta value)
                                throws IOException {
