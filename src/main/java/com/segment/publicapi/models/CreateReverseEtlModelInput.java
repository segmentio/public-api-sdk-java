...
public class CreateReverseEtlModelInput {
    ...
    @ApiModelProperty(required = true, value = "Indicates which Source to attach this model to.")
    ...
    public CreateReverseEtlModelInput scheduleConfig(Map scheduleConfig) {
     ...
     * @throws IOException if the JSON Object is invalid with respect to CreateReverseEtlModelInput
     */
