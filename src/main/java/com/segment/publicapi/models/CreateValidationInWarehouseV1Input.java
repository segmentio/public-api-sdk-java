...
public class CreateValidationInWarehouseV1Input {
    ...
    public boolean equals(Object o) {
        ...
        CreateValidationInWarehouseV1Input createValidationInWarehouseV1Input =
                (CreateValidationInWarehouseV1Input) o;
            ...
            if (!CreateValidationInWarehouseV1Input.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                ...
                                CreateValidationInWarehouseV1Input.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateValidationInWarehouseV1Input.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateValidationInWarehouseV1Input' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateValidationInWarehouseV1Input> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreateValidationInWarehouseV1Input.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreateValidationInWarehouseV1Input>() {
                        @Override
                        public void write(JsonWriter out, CreateValidationInWarehouseV1Input value)
                                throws IOException {
     ...
     *     CreateValidationInWarehouseV1Input
     */
    public static CreateValidationInWarehouseV1Input fromJson(String jsonString)
            throws IOException {
