...
public class CreateEdgeFunctionsAlphaInput {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The id of the Source associated with this Edge Function.")
  ...
  public boolean equals(Object o) {
    ...
    CreateEdgeFunctionsAlphaInput createEdgeFunctionsAlphaInput = (CreateEdgeFunctionsAlphaInput) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateEdgeFunctionsAlphaInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateEdgeFunctionsAlphaInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEdgeFunctionsAlphaInput is not found in the empty JSON string", CreateEdgeFunctionsAlphaInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateEdgeFunctionsAlphaInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEdgeFunctionsAlphaInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEdgeFunctionsAlphaInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEdgeFunctionsAlphaInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEdgeFunctionsAlphaInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEdgeFunctionsAlphaInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEdgeFunctionsAlphaInput>() {
           @Override
           public void write(JsonWriter out, CreateEdgeFunctionsAlphaInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEdgeFunctionsAlphaInput read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateEdgeFunctionsAlphaInput
  */
