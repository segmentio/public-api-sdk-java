...
import com.segment.publicapi.models.Source4;
...
public class GetSourceV1Output {
  ...
  public GetSourceV1Output source(Source4 source) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetSourceV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetSourceV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSourceV1Output is not found in the empty JSON string", GetSourceV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetSourceV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSourceV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetSourceV1Output>() {
           @Override
           public void write(JsonWriter out, GetSourceV1Output value) throws IOException {
