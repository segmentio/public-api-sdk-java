 ...
 */
@ApiModel(description = "Represents a Destination within Segment.  A Destination is a target for Segment to forward data to, and represents a tool or storage Destination.")
...
public class DestinationMetadataV1 {
  ...
  **/
  ...
  public DestinationMetadataV1 addPresetsItem(DestinationMetadataSubscriptionPresetV1 presetsItem) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DestinationMetadataV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationMetadataV1 is not found in the empty JSON string", DestinationMetadataV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DestinationMetadataV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationMetadataV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DestinationMetadataV1>() {
           @Override
           public void write(JsonWriter out, DestinationMetadataV1 value) throws IOException {
