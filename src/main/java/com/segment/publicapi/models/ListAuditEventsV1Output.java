...
import com.segment.publicapi.models.AuditEventV1;
...
public class ListAuditEventsV1Output {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListAuditEventsV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAuditEventsV1Output is not found in the empty JSON string", ListAuditEventsV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListAuditEventsV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAuditEventsV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAuditEventsV1Output.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAuditEventsV1Output' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListAuditEventsV1Output>() {
           @Override
           public void write(JsonWriter out, ListAuditEventsV1Output value) throws IOException {
