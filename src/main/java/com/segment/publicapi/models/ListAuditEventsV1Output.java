...
public class ListAuditEventsV1Output {
    ...
    public ListAuditEventsV1Output pagination(PaginationOutput pagination) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to ListAuditEventsV1Output
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (int i = 0; i < jsonArrayevents.size(); i++) {
            AuditEventV1.validateJsonElement(jsonArrayevents.get(i));
        }
        ;
