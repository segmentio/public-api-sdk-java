...
@ApiModel(
        description =
                "The schedule that contains the schedule overrides for the specified Warehouse, if"
                        + " enabled.")
public class Schedule {
    ...
    public Schedule times(List<WarehouseAdvancedSyncV1> times) {

        this.times = times;
        return this;
    }

    public Schedule addTimesItem(WarehouseAdvancedSyncV1 timesItem) {
        if (this.times == null) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.times, schedule.times)
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Schedule.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Schedule is not found in the empty"
                                        + " JSON string",
