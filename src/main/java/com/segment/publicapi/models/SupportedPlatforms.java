 ...
 */
@ApiModel(description = "Platforms from which the Destination receives events.  Config API note: equal to `platforms`.")
...
public class SupportedPlatforms {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SupportedPlatforms.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportedPlatforms is not found in the empty JSON string", SupportedPlatforms.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SupportedPlatforms.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportedPlatforms` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SupportedPlatforms>() {
           @Override
           public void write(JsonWriter out, SupportedPlatforms value) throws IOException {
