 ...
 */
@ApiModel(description = "Preview output from applying the Destination filter. Segment modifies or nullifies payloads depending on the provided filter actions.")
...
public class PreviewDestinationFilterV1Output {
  ...
  public PreviewDestinationFilterV1Output putInputPayloadItem(String key, Object inputPayloadItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PreviewDestinationFilterV1Output previewDestinationFilterV1Output = (PreviewDestinationFilterV1Output) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to PreviewDestinationFilterV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PreviewDestinationFilterV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PreviewDestinationFilterV1Output is not found in the empty JSON string", PreviewDestinationFilterV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PreviewDestinationFilterV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PreviewDestinationFilterV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PreviewDestinationFilterV1Output.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PreviewDestinationFilterV1Output' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PreviewDestinationFilterV1Output> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PreviewDestinationFilterV1Output.class));

       return (TypeAdapter<T>) new TypeAdapter<PreviewDestinationFilterV1Output>() {
           @Override
           public void write(JsonWriter out, PreviewDestinationFilterV1Output value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PreviewDestinationFilterV1Output read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PreviewDestinationFilterV1Output
  */
