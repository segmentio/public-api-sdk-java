...
import com.segment.publicapi.models.DestinationMetadata;
...
public class GetDestinationMetadataV1Output {
  ...
  public GetDestinationMetadataV1Output destinationMetadata(DestinationMetadata destinationMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetDestinationMetadataV1Output getDestinationMetadataV1Output = (GetDestinationMetadataV1Output) o;
    return Objects.equals(this.destinationMetadata, getDestinationMetadataV1Output.destinationMetadata);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetDestinationMetadataV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetDestinationMetadataV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDestinationMetadataV1Output is not found in the empty JSON string", GetDestinationMetadataV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetDestinationMetadataV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDestinationMetadataV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDestinationMetadataV1Output.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDestinationMetadataV1Output' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDestinationMetadataV1Output> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDestinationMetadataV1Output.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDestinationMetadataV1Output>() {
           @Override
           public void write(JsonWriter out, GetDestinationMetadataV1Output value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDestinationMetadataV1Output read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GetDestinationMetadataV1Output
  */
