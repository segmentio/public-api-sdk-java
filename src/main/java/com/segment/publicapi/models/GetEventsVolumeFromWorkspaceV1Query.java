...
public class GetEventsVolumeFromWorkspaceV1Query {
    ...
    public GetEventsVolumeFromWorkspaceV1Query workspaceId(String workspaceId) {
    ...
    public GetEventsVolumeFromWorkspaceV1Query granularity(GranularityEnum granularity) {
    ...
    public GetEventsVolumeFromWorkspaceV1Query startTime(String startTime) {
    ...
    public GetEventsVolumeFromWorkspaceV1Query endTime(String endTime) {
    ...
    /**
     * EndTime is the ISO8601 formatted timestamp corresponding to the end of the requested time
     * frame, noninclusive.
     *
     * @return endTime
     */
    ...
    public GetEventsVolumeFromWorkspaceV1Query groupBy(List<String> groupBy) {

        this.groupBy = groupBy;
        return this;
    }

    public GetEventsVolumeFromWorkspaceV1Query addGroupByItem(String groupByItem) {
    ...
    public GetEventsVolumeFromWorkspaceV1Query sourceId(List<String> sourceId) {

        this.sourceId = sourceId;
        return this;
    }

    public GetEventsVolumeFromWorkspaceV1Query addSourceIdItem(String sourceIdItem) {
    ...
    public GetEventsVolumeFromWorkspaceV1Query eventName(List<String> eventName) {

        this.eventName = eventName;
        return this;
    }

    public GetEventsVolumeFromWorkspaceV1Query addEventNameItem(String eventNameItem) {
    ...
    /**
     * EventName is a list of strings which allow you to restrict the result to just the given event
     * names.
     *
     * @return eventName
     */
    ...
    public GetEventsVolumeFromWorkspaceV1Query eventType(List<String> eventType) {

        this.eventType = eventType;
        return this;
    }

    public GetEventsVolumeFromWorkspaceV1Query addEventTypeItem(String eventTypeItem) {
    ...
    /**
     * EventType is a list of strings which allow you to restrict the result to just the given event
     * types.
     *
     * @return eventType
     */
    ...
    public GetEventsVolumeFromWorkspaceV1Query appVersion(List<String> appVersion) {

        this.appVersion = appVersion;
        return this;
    }

    public GetEventsVolumeFromWorkspaceV1Query addAppVersionItem(String appVersionItem) {
    ...
    public GetEventsVolumeFromWorkspaceV1Query limit(BigDecimal limit) {
    ...
    public boolean equals(Object o) {
        ...
        GetEventsVolumeFromWorkspaceV1Query getEventsVolumeFromWorkspaceV1Query =
                (GetEventsVolumeFromWorkspaceV1Query) o;
        return Objects.equals(this.workspaceId, getEventsVolumeFromWorkspaceV1Query.workspaceId)
                && Objects.equals(this.granularity, getEventsVolumeFromWorkspaceV1Query.granularity)
                && Objects.equals(this.startTime, getEventsVolumeFromWorkspaceV1Query.startTime)
                && Objects.equals(this.endTime, getEventsVolumeFromWorkspaceV1Query.endTime)
                && Objects.equals(this.groupBy, getEventsVolumeFromWorkspaceV1Query.groupBy)
                && Objects.equals(this.sourceId, getEventsVolumeFromWorkspaceV1Query.sourceId)
                && Objects.equals(this.eventName, getEventsVolumeFromWorkspaceV1Query.eventName)
                && Objects.equals(this.eventType, getEventsVolumeFromWorkspaceV1Query.eventType)
                && Objects.equals(this.appVersion, getEventsVolumeFromWorkspaceV1Query.appVersion)
                && Objects.equals(this.limit, getEventsVolumeFromWorkspaceV1Query.limit);
    }
            ...
            if (!GetEventsVolumeFromWorkspaceV1Query.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                ...
                                GetEventsVolumeFromWorkspaceV1Query.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetEventsVolumeFromWorkspaceV1Query.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetEventsVolumeFromWorkspaceV1Query' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetEventsVolumeFromWorkspaceV1Query> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetEventsVolumeFromWorkspaceV1Query.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetEventsVolumeFromWorkspaceV1Query>() {
                        @Override
                        public void write(JsonWriter out, GetEventsVolumeFromWorkspaceV1Query value)
                                throws IOException {
    ...
    /**
     * Create an instance of GetEventsVolumeFromWorkspaceV1Query given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetEventsVolumeFromWorkspaceV1Query
     * @throws IOException if the JSON string is invalid with respect to
     *     GetEventsVolumeFromWorkspaceV1Query
     */
    public static GetEventsVolumeFromWorkspaceV1Query fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetEventsVolumeFromWorkspaceV1Query.class);
    }

    /**
     * Convert an instance of GetEventsVolumeFromWorkspaceV1Query to an JSON string
     *
     * @return JSON string
     */
