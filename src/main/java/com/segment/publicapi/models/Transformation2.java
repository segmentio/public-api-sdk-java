...
public class Transformation2 {
    ...
    public Transformation2 propertyValueTransformations(
    ...
    public Transformation2 addPropertyValueTransformationsItem(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, transformation2.id)
                ...
                && Objects.equals(
                        ...
                        transformation2.propertyValueTransformations);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Transformation2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Transformation2 is not found in the"
                                        + " empty JSON string",
                                Transformation2.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Transformation2` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<Transformation2>() {
                        @Override
                        public void write(JsonWriter out, Transformation2 value)
                                throws IOException {
