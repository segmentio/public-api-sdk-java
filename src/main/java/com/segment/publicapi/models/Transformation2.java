...
public class Transformation2 {
  ...
  public Transformation2 id(String id) {
  ...
  **/
  ...
  public Transformation2 name(String name) {
  ...
  **/
  ...
  public Transformation2 sourceId(String sourceId) {
  ...
  **/
  ...
  public Transformation2 destinationMetadataId(String destinationMetadataId) {
  ...
  **/
  ...
  public Transformation2 enabled(Boolean enabled) {
  ...
  **/
  ...
  public Transformation2 _if(String _if) {
  ...
  **/
  ...
  public Transformation2 newEventName(String newEventName) {
  ...
  **/
  ...
  public Transformation2 propertyRenames(List<PropertyRenameBeta> propertyRenames) {
    
    this.propertyRenames = propertyRenames;
    return this;
  }

  public Transformation2 addPropertyRenamesItem(PropertyRenameBeta propertyRenamesItem) {
  ...
  **/
  ...
  public Transformation2 propertyValueTransformations(List<PropertyValueTransformationBeta> propertyValueTransformations) {
    
    this.propertyValueTransformations = propertyValueTransformations;
    return this;
  }

  public Transformation2 addPropertyValueTransformationsItem(PropertyValueTransformationBeta propertyValueTransformationsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Transformation2 transformation2 = (Transformation2) o;
    return Objects.equals(this.id, transformation2.id) &&
        Objects.equals(this.name, transformation2.name) &&
        Objects.equals(this.sourceId, transformation2.sourceId) &&
        Objects.equals(this.destinationMetadataId, transformation2.destinationMetadataId) &&
        Objects.equals(this.enabled, transformation2.enabled) &&
        Objects.equals(this._if, transformation2._if) &&
        Objects.equals(this.newEventName, transformation2.newEventName) &&
        Objects.equals(this.propertyRenames, transformation2.propertyRenames) &&
        Objects.equals(this.propertyValueTransformations, transformation2.propertyValueTransformations);
  }
  ...
  public String toString() {
    ...
    sb.append("class Transformation2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Transformation2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Transformation2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transformation2 is not found in the empty JSON string", Transformation2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Transformation2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transformation2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Transformation2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transformation2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transformation2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transformation2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transformation2.class));

       return (TypeAdapter<T>) new TypeAdapter<Transformation2>() {
           @Override
           public void write(JsonWriter out, Transformation2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transformation2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Transformation2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Transformation2
  * @throws IOException if the JSON string is invalid with respect to Transformation2
  */
  public static Transformation2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transformation2.class);
  }

 /**
  * Convert an instance of Transformation2 to an JSON string
  *
  * @return JSON string
  */
