...
public class Input {
  ...
  **/
  ...
  public Input trigger(String trigger) {
  ...
  **/
  ...
  public Input enabled(Boolean enabled) {
  ...
  **/
  ...
  public Input settings(Map settings) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, input.name) &&
        ...
        Objects.equals(this.enabled, input.enabled) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to Input
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Input.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Input` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
