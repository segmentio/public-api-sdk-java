...
public class UpdateDestinationForAudienceAlphaOutput {
    ...
    public UpdateDestinationForAudienceAlphaOutput() {}

    public UpdateDestinationForAudienceAlphaOutput destination(Destination destination) {
    ...
    public UpdateDestinationForAudienceAlphaOutput idSyncConfiguration(
    ...
    public UpdateDestinationForAudienceAlphaOutput addIdSyncConfigurationItem(
    ...
    public UpdateDestinationForAudienceAlphaOutput connectionSettings(Object connectionSettings) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateDestinationForAudienceAlphaOutput updateDestinationForAudienceAlphaOutput =
                (UpdateDestinationForAudienceAlphaOutput) o;
        return Objects.equals(this.destination, updateDestinationForAudienceAlphaOutput.destination)
                && Objects.equals(
                        this.idSyncConfiguration,
                        updateDestinationForAudienceAlphaOutput.idSyncConfiguration)
                && Objects.equals(
                        this.connectionSettings,
                        updateDestinationForAudienceAlphaOutput.connectionSettings);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateDestinationForAudienceAlphaOutput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " UpdateDestinationForAudienceAlphaOutput is not found in the"
                                    + " empty JSON string",
                                UpdateDestinationForAudienceAlphaOutput.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!UpdateDestinationForAudienceAlphaOutput.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `UpdateDestinationForAudienceAlphaOutput` properties. JSON:"
                                    + " %s",
        ...
        for (String requiredField : UpdateDestinationForAudienceAlphaOutput.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateDestinationForAudienceAlphaOutput.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes 'UpdateDestinationForAudienceAlphaOutput'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UpdateDestinationForAudienceAlphaOutput> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(UpdateDestinationForAudienceAlphaOutput.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateDestinationForAudienceAlphaOutput>() {
                        @Override
                        public void write(
                                JsonWriter out, UpdateDestinationForAudienceAlphaOutput value)
                                throws IOException {
                        ...
                        @Override
                        public UpdateDestinationForAudienceAlphaOutput read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of UpdateDestinationForAudienceAlphaOutput given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateDestinationForAudienceAlphaOutput
     * @throws IOException if the JSON string is invalid with respect to
     *     UpdateDestinationForAudienceAlphaOutput
     */
    public static UpdateDestinationForAudienceAlphaOutput fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateDestinationForAudienceAlphaOutput.class);
    }

    /**
     * Convert an instance of UpdateDestinationForAudienceAlphaOutput to an JSON string
     *
     * @return JSON string
     */
