 ...
 */
@ApiModel(description = "The returned Warehouse object.")
...
public class Warehouse {
  ...
  **/
  ...
  public Warehouse metadata(Metadata2 metadata) {
  ...
  **/
  ...
  public Warehouse workspaceId(String workspaceId) {
  ...
  **/
  ...
  public Warehouse enabled(Boolean enabled) {
  ...
  **/
  ...
  public Warehouse settings(Map settings) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, warehouse.id) &&
        Objects.equals(this.metadata, warehouse.metadata) &&
        Objects.equals(this.workspaceId, warehouse.workspaceId) &&
        Objects.equals(this.enabled, warehouse.enabled) &&
        Objects.equals(this.settings, warehouse.settings);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Warehouse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Warehouse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
