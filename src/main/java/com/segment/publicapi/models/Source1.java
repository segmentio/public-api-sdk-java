...
public class Source1 {
  ...
  **/
  ...
  public Source1 slug(String slug) {
  ...
  **/
  ...
  public Source1 name(String name) {
  ...
  **/
  ...
  public Source1 metadata(Metadata1 metadata) {
  ...
  **/
  ...
  public Source1 workspaceId(String workspaceId) {
  ...
  **/
  ...
  public Source1 enabled(Boolean enabled) {
  ...
  **/
  ...
  public Source1 writeKeys(List<String> writeKeys) {
    
    this.writeKeys = writeKeys;
    return this;
  }

  public Source1 addWriteKeysItem(String writeKeysItem) {
  ...
  **/
  ...
  public Source1 settings(Map settings) {
  ...
  **/
  ...
  public Source1 labels(List<LabelV1> labels) {
    
    this.labels = labels;
    return this;
  }

  public Source1 addLabelsItem(LabelV1 labelsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, source1.id) &&
        Objects.equals(this.slug, source1.slug) &&
        Objects.equals(this.name, source1.name) &&
        Objects.equals(this.metadata, source1.metadata) &&
        Objects.equals(this.workspaceId, source1.workspaceId) &&
        Objects.equals(this.enabled, source1.enabled) &&
        Objects.equals(this.writeKeys, source1.writeKeys) &&
        Objects.equals(this.settings, source1.settings) &&
        Objects.equals(this.labels, source1.labels);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Source1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Source1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Source1 is not found in the empty JSON string", Source1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Source1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Source1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Source1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Source1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Source1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Source1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Source1.class));

       return (TypeAdapter<T>) new TypeAdapter<Source1>() {
           @Override
           public void write(JsonWriter out, Source1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Source1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Source1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Source1
  * @throws IOException if the JSON string is invalid with respect to Source1
  */
  public static Source1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Source1.class);
  }

 /**
  * Convert an instance of Source1 to an JSON string
  *
  * @return JSON string
  */
