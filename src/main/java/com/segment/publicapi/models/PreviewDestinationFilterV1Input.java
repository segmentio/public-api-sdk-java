...
import com.segment.publicapi.models.Filter;
 ...
 */
@ApiModel(description = "Input of the Destination filter to preview. For guidance on using FQL, see the Segment documentation site.")
...
public class PreviewDestinationFilterV1Input {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PreviewDestinationFilterV1Input previewDestinationFilterV1Input = (PreviewDestinationFilterV1Input) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to PreviewDestinationFilterV1Input
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PreviewDestinationFilterV1Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PreviewDestinationFilterV1Input is not found in the empty JSON string", PreviewDestinationFilterV1Input.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PreviewDestinationFilterV1Input.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PreviewDestinationFilterV1Input` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PreviewDestinationFilterV1Input.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PreviewDestinationFilterV1Input' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PreviewDestinationFilterV1Input> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PreviewDestinationFilterV1Input.class));

       return (TypeAdapter<T>) new TypeAdapter<PreviewDestinationFilterV1Input>() {
           @Override
           public void write(JsonWriter out, PreviewDestinationFilterV1Input value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PreviewDestinationFilterV1Input read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PreviewDestinationFilterV1Input
  */
