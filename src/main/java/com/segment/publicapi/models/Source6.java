...
public class Source6 {
  ...
  **/
  ...
  public Source6 slug(String slug) {
  ...
  **/
  ...
  public Source6 name(String name) {
  ...
  **/
  ...
  public Source6 metadata(Metadata1 metadata) {
  ...
  **/
  ...
  public Source6 workspaceId(String workspaceId) {
  ...
  **/
  ...
  public Source6 enabled(Boolean enabled) {
  ...
  **/
  ...
  public Source6 writeKeys(List<String> writeKeys) {
    
    this.writeKeys = writeKeys;
    return this;
  }

  public Source6 addWriteKeysItem(String writeKeysItem) {
  ...
  **/
  ...
  public Source6 settings(Map settings) {
  ...
  **/
  ...
  public Source6 labels(List<LabelV1> labels) {
    
    this.labels = labels;
    return this;
  }

  public Source6 addLabelsItem(LabelV1 labelsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Source6 source6 = (Source6) o;
    return Objects.equals(this.id, source6.id) &&
        Objects.equals(this.slug, source6.slug) &&
        Objects.equals(this.name, source6.name) &&
        Objects.equals(this.metadata, source6.metadata) &&
        Objects.equals(this.workspaceId, source6.workspaceId) &&
        Objects.equals(this.enabled, source6.enabled) &&
        Objects.equals(this.writeKeys, source6.writeKeys) &&
        Objects.equals(this.settings, source6.settings) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to Source6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Source6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Source6 is not found in the empty JSON string", Source6.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Source6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Source6` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Source6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Source6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Source6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Source6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Source6.class));

       return (TypeAdapter<T>) new TypeAdapter<Source6>() {
           @Override
           public void write(JsonWriter out, Source6 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Source6 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Source6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Source6
  * @throws IOException if the JSON string is invalid with respect to Source6
  */
  public static Source6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Source6.class);
  }

 /**
  * Convert an instance of Source6 to an JSON string
  *
  * @return JSON string
  */
