 ...
 * The updated Source.
 */
@ApiModel(description = "The updated Source.")
...
public class Source3 {
  ...
  **/
  ...
  public Source3 slug(String slug) {
  ...
  **/
  ...
  public Source3 name(String name) {
  ...
  **/
  ...
  public Source3 metadata(Metadata1 metadata) {
  ...
  **/
  ...
  public Source3 workspaceId(String workspaceId) {
  ...
  **/
  ...
  public Source3 enabled(Boolean enabled) {
  ...
  **/
  ...
  public Source3 writeKeys(List<String> writeKeys) {
    
    this.writeKeys = writeKeys;
    return this;
  }

  public Source3 addWriteKeysItem(String writeKeysItem) {
  ...
  **/
  ...
  public Source3 settings(Map settings) {
  ...
  **/
  ...
  public Source3 labels(List<LabelV1> labels) {
    
    this.labels = labels;
    return this;
  }

  public Source3 addLabelsItem(LabelV1 labelsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Source3 source3 = (Source3) o;
    return Objects.equals(this.id, source3.id) &&
        Objects.equals(this.slug, source3.slug) &&
        Objects.equals(this.name, source3.name) &&
        Objects.equals(this.metadata, source3.metadata) &&
        Objects.equals(this.workspaceId, source3.workspaceId) &&
        Objects.equals(this.enabled, source3.enabled) &&
        Objects.equals(this.writeKeys, source3.writeKeys) &&
        Objects.equals(this.settings, source3.settings) &&
        Objects.equals(this.labels, source3.labels);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Source3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Source3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Source3 is not found in the empty JSON string", Source3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Source3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Source3` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Source3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Source3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Source3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Source3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Source3.class));

       return (TypeAdapter<T>) new TypeAdapter<Source3>() {
           @Override
           public void write(JsonWriter out, Source3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Source3 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Source3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Source3
  * @throws IOException if the JSON string is invalid with respect to Source3
  */
  public static Source3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Source3.class);
  }

 /**
  * Convert an instance of Source3 to an JSON string
  *
  * @return JSON string
  */
