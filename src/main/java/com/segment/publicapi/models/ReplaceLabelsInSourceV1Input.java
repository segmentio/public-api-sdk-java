...
public class ReplaceLabelsInSourceV1Input {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReplaceLabelsInSourceV1Input replaceLabelsInSourceV1Input = (ReplaceLabelsInSourceV1Input) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReplaceLabelsInSourceV1Input
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReplaceLabelsInSourceV1Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplaceLabelsInSourceV1Input is not found in the empty JSON string", ReplaceLabelsInSourceV1Input.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReplaceLabelsInSourceV1Input.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplaceLabelsInSourceV1Input` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplaceLabelsInSourceV1Input.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplaceLabelsInSourceV1Input' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplaceLabelsInSourceV1Input> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplaceLabelsInSourceV1Input.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplaceLabelsInSourceV1Input>() {
           @Override
           public void write(JsonWriter out, ReplaceLabelsInSourceV1Input value) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ReplaceLabelsInSourceV1Input
  */
