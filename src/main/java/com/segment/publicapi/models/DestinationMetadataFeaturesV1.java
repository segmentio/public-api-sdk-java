...
public class DestinationMetadataFeaturesV1 {
    ...
    public DestinationMetadataFeaturesV1 cloudModeInstances(
            CloudModeInstancesEnum cloudModeInstances) {
    ...
    public DestinationMetadataFeaturesV1 deviceModeInstances(
            DeviceModeInstancesEnum deviceModeInstances) {
    ...
    public boolean equals(Object o) {
        ...
        DestinationMetadataFeaturesV1 destinationMetadataFeaturesV1 =
                (DestinationMetadataFeaturesV1) o;
        return Objects.equals(
                        this.cloudModeInstances, destinationMetadataFeaturesV1.cloudModeInstances)
                && Objects.equals(
                        this.deviceModeInstances, destinationMetadataFeaturesV1.deviceModeInstances)
                && Objects.equals(this.replay, destinationMetadataFeaturesV1.replay)
                && Objects.equals(
                        this.browserUnbundling, destinationMetadataFeaturesV1.browserUnbundling)
                && Objects.equals(
                        this.browserUnbundlingPublic,
                        destinationMetadataFeaturesV1.browserUnbundlingPublic);
    }
            ...
            if (!DestinationMetadataFeaturesV1.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                ...
                                DestinationMetadataFeaturesV1.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DestinationMetadataFeaturesV1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DestinationMetadataFeaturesV1' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<DestinationMetadataFeaturesV1> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(DestinationMetadataFeaturesV1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<DestinationMetadataFeaturesV1>() {
                        @Override
                        public void write(JsonWriter out, DestinationMetadataFeaturesV1 value)
                                throws IOException {
