...
public class UpdateFilterForDestinationV1Input {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateFilterForDestinationV1Input updateFilterForDestinationV1Input = (UpdateFilterForDestinationV1Input) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateFilterForDestinationV1Input
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateFilterForDestinationV1Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFilterForDestinationV1Input is not found in the empty JSON string", UpdateFilterForDestinationV1Input.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateFilterForDestinationV1Input.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFilterForDestinationV1Input` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFilterForDestinationV1Input.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFilterForDestinationV1Input' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFilterForDestinationV1Input> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFilterForDestinationV1Input.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFilterForDestinationV1Input>() {
           @Override
           public void write(JsonWriter out, UpdateFilterForDestinationV1Input value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFilterForDestinationV1Input read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateFilterForDestinationV1Input
  */
