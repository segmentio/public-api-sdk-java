...
public class CreateDestinationSubscriptionAlphaInput {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The associated action id the subscription should trigger.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateDestinationSubscriptionAlphaInput createDestinationSubscriptionAlphaInput = (CreateDestinationSubscriptionAlphaInput) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateDestinationSubscriptionAlphaInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDestinationSubscriptionAlphaInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDestinationSubscriptionAlphaInput is not found in the empty JSON string", CreateDestinationSubscriptionAlphaInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateDestinationSubscriptionAlphaInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDestinationSubscriptionAlphaInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDestinationSubscriptionAlphaInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDestinationSubscriptionAlphaInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDestinationSubscriptionAlphaInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDestinationSubscriptionAlphaInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDestinationSubscriptionAlphaInput>() {
           @Override
           public void write(JsonWriter out, CreateDestinationSubscriptionAlphaInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDestinationSubscriptionAlphaInput read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateDestinationSubscriptionAlphaInput
  */
  public static CreateDestinationSubscriptionAlphaInput fromJson(String jsonString) throws IOException {
