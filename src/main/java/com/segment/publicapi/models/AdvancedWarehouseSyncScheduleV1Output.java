...
public class AdvancedWarehouseSyncScheduleV1Output {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AdvancedWarehouseSyncScheduleV1Output advancedWarehouseSyncScheduleV1Output = (AdvancedWarehouseSyncScheduleV1Output) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to AdvancedWarehouseSyncScheduleV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AdvancedWarehouseSyncScheduleV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdvancedWarehouseSyncScheduleV1Output is not found in the empty JSON string", AdvancedWarehouseSyncScheduleV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AdvancedWarehouseSyncScheduleV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdvancedWarehouseSyncScheduleV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdvancedWarehouseSyncScheduleV1Output.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdvancedWarehouseSyncScheduleV1Output' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdvancedWarehouseSyncScheduleV1Output> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdvancedWarehouseSyncScheduleV1Output.class));

       return (TypeAdapter<T>) new TypeAdapter<AdvancedWarehouseSyncScheduleV1Output>() {
           @Override
           public void write(JsonWriter out, AdvancedWarehouseSyncScheduleV1Output value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdvancedWarehouseSyncScheduleV1Output read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to AdvancedWarehouseSyncScheduleV1Output
  */
  public static AdvancedWarehouseSyncScheduleV1Output fromJson(String jsonString) throws IOException {
