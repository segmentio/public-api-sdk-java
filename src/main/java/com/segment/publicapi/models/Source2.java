...
public class Source2 {
  ...
  **/
  ...
  public Source2 slug(String slug) {
  ...
  **/
  ...
  public Source2 name(String name) {
  ...
  **/
  ...
  public Source2 workspaceId(String workspaceId) {
  ...
  **/
  ...
  public Source2 enabled(Boolean enabled) {
  ...
  **/
  ...
  public Source2 writeKeys(List<String> writeKeys) {
    
    this.writeKeys = writeKeys;
    return this;
  }

  public Source2 addWriteKeysItem(String writeKeysItem) {
  ...
  **/
  ...
  public Source2 settings(Map settings) {
  ...
  **/
  ...
  public Source2 labels(List<LabelV1> labels) {
    
    this.labels = labels;
    return this;
  }

  public Source2 addLabelsItem(LabelV1 labelsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Source2 source2 = (Source2) o;
    return Objects.equals(this.id, source2.id) &&
        Objects.equals(this.slug, source2.slug) &&
        Objects.equals(this.name, source2.name) &&
        Objects.equals(this.metadata, source2.metadata) &&
        Objects.equals(this.workspaceId, source2.workspaceId) &&
        Objects.equals(this.enabled, source2.enabled) &&
        Objects.equals(this.writeKeys, source2.writeKeys) &&
        Objects.equals(this.settings, source2.settings) &&
        Objects.equals(this.labels, source2.labels);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Source2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Source2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Source2 is not found in the empty JSON string", Source2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Source2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Source2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Source2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Source2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Source2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Source2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Source2.class));

       return (TypeAdapter<T>) new TypeAdapter<Source2>() {
           @Override
           public void write(JsonWriter out, Source2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Source2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Source2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Source2
  * @throws IOException if the JSON string is invalid with respect to Source2
  */
  public static Source2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Source2.class);
  }

 /**
  * Convert an instance of Source2 to an JSON string
  *
  * @return JSON string
  */
