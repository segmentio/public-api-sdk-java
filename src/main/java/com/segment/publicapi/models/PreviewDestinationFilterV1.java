 ...
 */
@ApiModel(description = "A simplified Destination filter that includes the if and actions for a DestinationFilterV1.")
...
public class PreviewDestinationFilterV1 {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "A FQL statement which determines if the provided filter's actions will apply to the provided JSON payload. The literal string \"all\" will result in this filter to all events. For guidance on using FQL, see the Segment documentation site.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The filtering action to take on events that match the \"if\" statement. Action types must be one of: \"drop\", \"allow_properties\", \"drop_properties\" or \"sample\".")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PreviewDestinationFilterV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PreviewDestinationFilterV1 is not found in the empty JSON string", PreviewDestinationFilterV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PreviewDestinationFilterV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PreviewDestinationFilterV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PreviewDestinationFilterV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PreviewDestinationFilterV1' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<PreviewDestinationFilterV1>() {
           @Override
           public void write(JsonWriter out, PreviewDestinationFilterV1 value) throws IOException {
