...
public class SourceSettingsOutputV1 {
  ...
  public SourceSettingsOutputV1() {
  }

  public SourceSettingsOutputV1 track(Track track) {
  ...
  **/
  ...
  public SourceSettingsOutputV1 identify(Identify identify) {
  ...
  **/
  ...
  public SourceSettingsOutputV1 group(Group group) {
  ...
  **/
  ...
  public SourceSettingsOutputV1 forwardingViolationsTo(String forwardingViolationsTo) {
  ...
  **/
  ...
  public SourceSettingsOutputV1 forwardingBlockedEventsTo(String forwardingBlockedEventsTo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SourceSettingsOutputV1 sourceSettingsOutputV1 = (SourceSettingsOutputV1) o;
    return Objects.equals(this.track, sourceSettingsOutputV1.track) &&
        Objects.equals(this.identify, sourceSettingsOutputV1.identify) &&
        Objects.equals(this.group, sourceSettingsOutputV1.group) &&
        Objects.equals(this.forwardingViolationsTo, sourceSettingsOutputV1.forwardingViolationsTo) &&
        Objects.equals(this.forwardingBlockedEventsTo, sourceSettingsOutputV1.forwardingBlockedEventsTo);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SourceSettingsOutputV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SourceSettingsOutputV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceSettingsOutputV1 is not found in the empty JSON string", SourceSettingsOutputV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SourceSettingsOutputV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceSettingsOutputV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceSettingsOutputV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceSettingsOutputV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceSettingsOutputV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceSettingsOutputV1.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceSettingsOutputV1>() {
           @Override
           public void write(JsonWriter out, SourceSettingsOutputV1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SourceSettingsOutputV1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SourceSettingsOutputV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SourceSettingsOutputV1
  * @throws IOException if the JSON string is invalid with respect to SourceSettingsOutputV1
  */
  public static SourceSettingsOutputV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceSettingsOutputV1.class);
  }

 /**
  * Convert an instance of SourceSettingsOutputV1 to an JSON string
  *
  * @return JSON string
  */
