 ...
 */
@ApiModel(description = "The full sync schedule for the Warehouse.")
...
public class Schedule1 {
  ...
  public Schedule1 times(List<WarehouseAdvancedSyncV1> times) {
    
    this.times = times;
    return this;
  }

  public Schedule1 addTimesItem(WarehouseAdvancedSyncV1 timesItem) {
  ...
  **/
  ...
  public Schedule1 timezone(String timezone) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Schedule1 schedule1 = (Schedule1) o;
    return Objects.equals(this.times, schedule1.times) &&
        Objects.equals(this.timezone, schedule1.timezone);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Schedule1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Schedule1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Schedule1 is not found in the empty JSON string", Schedule1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Schedule1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Schedule1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Schedule1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Schedule1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Schedule1.class));
