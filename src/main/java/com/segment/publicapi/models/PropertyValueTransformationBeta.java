...
public class PropertyValueTransformationBeta {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The property paths.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PropertyValueTransformationBeta propertyValueTransformationBeta = (PropertyValueTransformationBeta) o;
    return Objects.equals(this.propertyPaths, propertyValueTransformationBeta.propertyPaths) &&
        Objects.equals(this.propertyValue, propertyValueTransformationBeta.propertyValue);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PropertyValueTransformationBeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PropertyValueTransformationBeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PropertyValueTransformationBeta is not found in the empty JSON string", PropertyValueTransformationBeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PropertyValueTransformationBeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PropertyValueTransformationBeta` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("propertyPaths") == null) {
        ...
        throw new IllegalArgumentException(String.format("Expected the field `propertyPaths` to be an array in the JSON string but got `%s`", jsonObj.get("propertyPaths").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PropertyValueTransformationBeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PropertyValueTransformationBeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PropertyValueTransformationBeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PropertyValueTransformationBeta.class));

       return (TypeAdapter<T>) new TypeAdapter<PropertyValueTransformationBeta>() {
           @Override
           public void write(JsonWriter out, PropertyValueTransformationBeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PropertyValueTransformationBeta read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PropertyValueTransformationBeta
  */
