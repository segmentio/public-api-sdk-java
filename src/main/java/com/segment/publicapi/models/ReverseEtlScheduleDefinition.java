...
public class ReverseEtlScheduleDefinition {
    ...
    private ReverseEtlScheduleConfig config;
    ...
    public ReverseEtlScheduleDefinition config(ReverseEtlScheduleConfig config) {
     ...
     */
    @javax.annotation.Nonnull
    public ReverseEtlScheduleConfig getConfig() {
        return config;
    }

    public void setConfig(ReverseEtlScheduleConfig config) {
        this.config = config;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        ReverseEtlScheduleConfig.validateJsonElement(jsonObj.get("config"));
    }
