 ...
 */
@ApiModel(description = "A registered set of permissions for a subject, extending a role to a resource.")
...
public class PermissionV1 {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The name of the role associated with this permission.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The id of the role associated with this permission.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PermissionV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PermissionV1 is not found in the empty JSON string", PermissionV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PermissionV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PermissionV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PermissionV1>() {
           @Override
