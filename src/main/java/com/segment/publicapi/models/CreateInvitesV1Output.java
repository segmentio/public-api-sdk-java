 ...
 */
@ApiModel(description = "Returns the emails of the invited users.")
...
public class CreateInvitesV1Output {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The list of emails invited to the Workspace.")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateInvitesV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateInvitesV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateInvitesV1Output is not found in the empty JSON string", CreateInvitesV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateInvitesV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInvitesV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateInvitesV1Output>() {
           @Override
           public void write(JsonWriter out, CreateInvitesV1Output value) throws IOException {
