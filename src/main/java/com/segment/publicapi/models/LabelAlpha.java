...
public class LabelAlpha {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!LabelAlpha.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LabelAlpha is not found in the empty"
                                        + " JSON string",
                                LabelAlpha.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<LabelAlpha> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(LabelAlpha.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<LabelAlpha>() {
                        @Override
