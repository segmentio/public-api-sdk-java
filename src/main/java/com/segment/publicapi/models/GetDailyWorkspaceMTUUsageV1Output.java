...
public class GetDailyWorkspaceMTUUsageV1Output {
    ...
    public GetDailyWorkspaceMTUUsageV1Output addDailyWorkspaceMTUUsageItem(
        ...
        if (this.dailyWorkspaceMTUUsage == null) {
            this.dailyWorkspaceMTUUsage = new ArrayList<>();
        }
    ...
    public GetDailyWorkspaceMTUUsageV1Output pagination(PaginationOutput pagination) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the required field `dailyWorkspaceMTUUsage` (array)
        for (int i = 0; i < jsonArraydailyWorkspaceMTUUsage.size(); i++) {
            MtuSnapshotV1.validateJsonElement(jsonArraydailyWorkspaceMTUUsage.get(i));
        }
        ;
