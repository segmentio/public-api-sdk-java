...
import com.segment.publicapi.models.MtuSnapshotV1;
...
public class GetDailyWorkspaceMTUUsageV1Output {
  public static final String SERIALIZED_NAME_DAILY_WORKSPACE_M_T_U_USAGE = "dailyWorkspaceMTUUsage";
  ...
  public GetDailyWorkspaceMTUUsageV1Output dailyWorkspaceMTUUsage(List<MtuSnapshotV1> dailyWorkspaceMTUUsage) {
    
    this.dailyWorkspaceMTUUsage = dailyWorkspaceMTUUsage;
    return this;
  }

  public GetDailyWorkspaceMTUUsageV1Output addDailyWorkspaceMTUUsageItem(MtuSnapshotV1 dailyWorkspaceMTUUsageItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetDailyWorkspaceMTUUsageV1Output getDailyWorkspaceMTUUsageV1Output = (GetDailyWorkspaceMTUUsageV1Output) o;
    return Objects.equals(this.dailyWorkspaceMTUUsage, getDailyWorkspaceMTUUsageV1Output.dailyWorkspaceMTUUsage) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetDailyWorkspaceMTUUsageV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetDailyWorkspaceMTUUsageV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDailyWorkspaceMTUUsageV1Output is not found in the empty JSON string", GetDailyWorkspaceMTUUsageV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetDailyWorkspaceMTUUsageV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDailyWorkspaceMTUUsageV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (!jsonObj.get("dailyWorkspaceMTUUsage").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `dailyWorkspaceMTUUsage` to be an array in the JSON string but got `%s`", jsonObj.get("dailyWorkspaceMTUUsage").toString()));
      }

      JsonArray jsonArraydailyWorkspaceMTUUsage = jsonObj.getAsJsonArray("dailyWorkspaceMTUUsage");
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDailyWorkspaceMTUUsageV1Output.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDailyWorkspaceMTUUsageV1Output' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDailyWorkspaceMTUUsageV1Output> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDailyWorkspaceMTUUsageV1Output.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDailyWorkspaceMTUUsageV1Output>() {
           @Override
           public void write(JsonWriter out, GetDailyWorkspaceMTUUsageV1Output value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDailyWorkspaceMTUUsageV1Output read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GetDailyWorkspaceMTUUsageV1Output
  */
