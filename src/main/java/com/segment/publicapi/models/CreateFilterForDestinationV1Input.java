...
public class CreateFilterForDestinationV1Input {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "When set to true, the Destination filter is active.")
  ...
  public boolean equals(Object o) {
    ...
    CreateFilterForDestinationV1Input createFilterForDestinationV1Input = (CreateFilterForDestinationV1Input) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateFilterForDestinationV1Input
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateFilterForDestinationV1Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFilterForDestinationV1Input is not found in the empty JSON string", CreateFilterForDestinationV1Input.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateFilterForDestinationV1Input.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFilterForDestinationV1Input` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFilterForDestinationV1Input.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFilterForDestinationV1Input' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFilterForDestinationV1Input> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFilterForDestinationV1Input.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFilterForDestinationV1Input>() {
           @Override
           public void write(JsonWriter out, CreateFilterForDestinationV1Input value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFilterForDestinationV1Input read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateFilterForDestinationV1Input
  */
