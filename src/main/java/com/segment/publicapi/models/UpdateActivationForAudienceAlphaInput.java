...
public class UpdateActivationForAudienceAlphaInput {
    ...
    /**
     * Activation name. For Warehouse Destinations, this is used as the table name. Omit this field
     * to leave the name unchanged. An empty string is ignored rather than applied.
     *
    ...
    public UpdateActivationForAudienceAlphaInput displayName(String displayName) {
     ...
     * Send null to clear. When omitted, the activationName is used as the label.
     *
     * @return displayName
     */
    @javax.annotation.Nullable
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.enabled, updateActivationForAudienceAlphaInput.enabled)
                ...
                && Objects.equals(
                        this.displayName, updateActivationForAudienceAlphaInput.displayName)
                && Objects.equals(
