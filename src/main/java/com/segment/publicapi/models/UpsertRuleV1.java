...
public class UpsertRuleV1 {
  ...
  **/
  ...
  public UpsertRuleV1 createdAt(String createdAt) {
  ...
  **/
  ...
  public UpsertRuleV1 updatedAt(String updatedAt) {
  ...
  **/
  ...
  public UpsertRuleV1 deprecatedAt(String deprecatedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.newKey, upsertRuleV1.newKey) &&
        ...
        Objects.equals(this.createdAt, upsertRuleV1.createdAt) &&
        Objects.equals(this.updatedAt, upsertRuleV1.updatedAt) &&
        Objects.equals(this.deprecatedAt, upsertRuleV1.deprecatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(newKey, type, key, jsonSchema, version, createdAt, updatedAt, deprecatedAt);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpsertRuleV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertRuleV1 is not found in the empty JSON string", UpsertRuleV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertRuleV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertRuleV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpsertRuleV1>() {
           @Override
