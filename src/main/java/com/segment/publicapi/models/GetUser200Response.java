...
public class GetUser200Response {
    ...
    private GetUserV1Output data;

    public GetUser200Response() {}

    public GetUser200Response data(GetUserV1Output data) {
    ...
    public GetUserV1Output getData() {
        return data;
    }

    public void setData(GetUserV1Output data) {
        this.data = data;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUser200Response.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetUser200Response is not found in the"
                                        + " empty JSON string",
                                GetUser200Response.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `GetUser200Response` properties. JSON: %s",
        ...
        if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
            GetUserV1Output.validateJsonElement(jsonObj.get("data"));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<GetUser200Response>() {
                        @Override
                        public void write(JsonWriter out, GetUser200Response value)
                                throws IOException {
