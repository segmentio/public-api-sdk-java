...
import com.segment.publicapi.models.AllowedLabelBeta;
 ...
 */
@ApiModel(description = "The most basic representation of a resource belonging to a set of permissions.")
...
public class PermissionResourceV1 {
  ...
  **/
  ...
  @ApiModelProperty(value = "The labels that further refine access to this resource. Labels are exclusive to Workspace-level permissions.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PermissionResourceV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PermissionResourceV1 is not found in the empty JSON string", PermissionResourceV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PermissionResourceV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PermissionResourceV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PermissionResourceV1>() {
           @Override
           public void write(JsonWriter out, PermissionResourceV1 value) throws IOException {
