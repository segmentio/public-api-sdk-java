...
public class Transformation1 {
    ...
    public Transformation1 propertyValueTransformations(
    ...
    public Transformation1 addPropertyValueTransformationsItem(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, transformation1.id)
                ...
                && Objects.equals(
                        ...
                        transformation1.propertyValueTransformations);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Transformation1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Transformation1 is not found in the"
                                        + " empty JSON string",
                                Transformation1.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Transformation1` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<Transformation1>() {
                        @Override
                        public void write(JsonWriter out, Transformation1 value)
                                throws IOException {
