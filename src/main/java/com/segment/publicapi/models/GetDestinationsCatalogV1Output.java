...
public class GetDestinationsCatalogV1Output {
  ...
  public GetDestinationsCatalogV1Output destinationsCatalog(List<DestinationMetadataV1> destinationsCatalog) {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetDestinationsCatalogV1Output>() {
           @Override
