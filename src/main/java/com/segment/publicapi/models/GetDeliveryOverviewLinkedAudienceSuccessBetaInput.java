...
public class GetDeliveryOverviewLinkedAudienceSuccessBetaInput {
    ...
    private DeliveryOverviewAudienceFilterBy filter;
    ...
    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput() {}

    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput sourceId(String sourceId) {
    ...
    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput destinationConfigId(
    ...
    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput startTime(String startTime) {
    ...
    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput endTime(String endTime) {
    ...
    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput groupBy(List<String> groupBy) {

        this.groupBy = groupBy;
        return this;
    }

    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput addGroupByItem(String groupByItem) {
     ...
     * Valid options are: &#x60;eventName&#x60;, &#x60;eventType&#x60;, &#x60;activationId&#x60;,
     * &#x60;audienceId&#x60;, and &#x60;spaceId&#x60;.
     *
     * @return groupBy
     */
    ...
    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput granularity(
    ...
    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput filter(
     ...
     */
    @javax.annotation.Nullable
    public DeliveryOverviewAudienceFilterBy getFilter() {
        return filter;
    }

    public void setFilter(DeliveryOverviewAudienceFilterBy filter) {
        this.filter = filter;
    }

    public GetDeliveryOverviewLinkedAudienceSuccessBetaInput pagination(
    ...
    public boolean equals(Object o) {
        ...
        GetDeliveryOverviewLinkedAudienceSuccessBetaInput
                getDeliveryOverviewLinkedAudienceSuccessBetaInput =
                        (GetDeliveryOverviewLinkedAudienceSuccessBetaInput) o;
        return Objects.equals(
                        this.sourceId, getDeliveryOverviewLinkedAudienceSuccessBetaInput.sourceId)
                && Objects.equals(
                        this.destinationConfigId,
                        getDeliveryOverviewLinkedAudienceSuccessBetaInput.destinationConfigId)
                && Objects.equals(
                        this.startTime, getDeliveryOverviewLinkedAudienceSuccessBetaInput.startTime)
                && Objects.equals(
                        this.endTime, getDeliveryOverviewLinkedAudienceSuccessBetaInput.endTime)
                && Objects.equals(
                        this.groupBy, getDeliveryOverviewLinkedAudienceSuccessBetaInput.groupBy)
                && Objects.equals(
                        this.granularity,
                        getDeliveryOverviewLinkedAudienceSuccessBetaInput.granularity)
                && Objects.equals(
                        this.filter, getDeliveryOverviewLinkedAudienceSuccessBetaInput.filter)
                && Objects.equals(
                        this.pagination,
                        getDeliveryOverviewLinkedAudienceSuccessBetaInput.pagination);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetDeliveryOverviewLinkedAudienceSuccessBetaInput {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetDeliveryOverviewLinkedAudienceSuccessBetaInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetDeliveryOverviewLinkedAudienceSuccessBetaInput is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetDeliveryOverviewLinkedAudienceSuccessBetaInput.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
        ...
        for (String requiredField :
                GetDeliveryOverviewLinkedAudienceSuccessBetaInput.openapiRequiredFields) {
        ...
        if (jsonObj.get("filter") != null && !jsonObj.get("filter").isJsonNull()) {
            DeliveryOverviewAudienceFilterBy.validateJsonElement(jsonObj.get("filter"));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetDeliveryOverviewLinkedAudienceSuccessBetaInput.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetDeliveryOverviewLinkedAudienceSuccessBetaInput' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetDeliveryOverviewLinkedAudienceSuccessBetaInput> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(GetDeliveryOverviewLinkedAudienceSuccessBetaInput.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetDeliveryOverviewLinkedAudienceSuccessBetaInput>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetDeliveryOverviewLinkedAudienceSuccessBetaInput value)
                                throws IOException {
                        ...
                        @Override
                        public GetDeliveryOverviewLinkedAudienceSuccessBetaInput read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetDeliveryOverviewLinkedAudienceSuccessBetaInput given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetDeliveryOverviewLinkedAudienceSuccessBetaInput
     * @throws IOException if the JSON string is invalid with respect to
     *     GetDeliveryOverviewLinkedAudienceSuccessBetaInput
     */
    public static GetDeliveryOverviewLinkedAudienceSuccessBetaInput fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetDeliveryOverviewLinkedAudienceSuccessBetaInput.class);
    }

    /**
     * Convert an instance of GetDeliveryOverviewLinkedAudienceSuccessBetaInput to an JSON string
     *
     * @return JSON string
     */
