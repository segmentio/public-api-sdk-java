...
@ApiModel(description = "Audience output for update.")
public class GetAudienceAlphaOutput {
    ...
    public GetAudienceAlphaOutput audience(Audience audience) {
     ...
     * @throws IOException if the JSON Object is invalid with respect to GetAudienceAlphaOutput
     */
