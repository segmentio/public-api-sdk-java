...
import com.segment.publicapi.models.DestinationStatusV1;
 ...
 */
@ApiModel(description = "StreamStatus represents status of each stream including all the Destinations corresponding to the stream.")
...
public class StreamStatusV1 {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StreamStatusV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StreamStatusV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamStatusV1 is not found in the empty JSON string", StreamStatusV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StreamStatusV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamStatusV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (!jsonObj.get("destinationStatus").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `destinationStatus` to be an array in the JSON string but got `%s`", jsonObj.get("destinationStatus").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StreamStatusV1>() {
           @Override
