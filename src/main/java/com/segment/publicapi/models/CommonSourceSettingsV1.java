...
public class CommonSourceSettingsV1 {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.track, commonSourceSettingsV1.track) &&
        ...
        Objects.equals(this.forwardingViolationsTo, commonSourceSettingsV1.forwardingViolationsTo) &&
        Objects.equals(this.forwardingBlockedEventsTo, commonSourceSettingsV1.forwardingBlockedEventsTo);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommonSourceSettingsV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonSourceSettingsV1 is not found in the empty JSON string", CommonSourceSettingsV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CommonSourceSettingsV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonSourceSettingsV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CommonSourceSettingsV1>() {
           @Override
           public void write(JsonWriter out, CommonSourceSettingsV1 value) throws IOException {
