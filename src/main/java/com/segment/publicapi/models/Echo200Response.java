...
public class Echo200Response {
    ...
    public Echo200Response data(EchoAlphaOutput data) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.data, echo200Response.data);
    }
     ...
     * @throws IOException if the JSON Object is invalid with respect to Echo200Response
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Echo200Response.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Echo200Response is not found in the"
                                        + " empty JSON string",
                                Echo200Response.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Echo200Response` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<Echo200Response>() {
                        @Override
                        public void write(JsonWriter out, Echo200Response value)
                                throws IOException {
