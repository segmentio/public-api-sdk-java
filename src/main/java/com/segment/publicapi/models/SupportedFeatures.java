 ...
 */
@ApiModel(description = "Features that this Destination supports.  Config API note: holds `browserUnbundling` fields.")
...
public class SupportedFeatures {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cloudModeInstances, supportedFeatures.cloudModeInstances) &&
        ...
        Objects.equals(this.browserUnbundlingPublic, supportedFeatures.browserUnbundlingPublic);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SupportedFeatures.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportedFeatures is not found in the empty JSON string", SupportedFeatures.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SupportedFeatures.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportedFeatures` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SupportedFeatures>() {
           @Override
           public void write(JsonWriter out, SupportedFeatures value) throws IOException {
