...
import com.segment.publicapi.models.CreateSourceAlphaOutput;
...
public class CreateSource200Response {
  ...
  public CreateSource200Response data(CreateSourceAlphaOutput data) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSource200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateSource200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSource200Response is not found in the empty JSON string", CreateSource200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateSource200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSource200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSource200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSource200Response' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateSource200Response>() {
           @Override
           public void write(JsonWriter out, CreateSource200Response value) throws IOException {
