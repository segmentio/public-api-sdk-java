...
public class CreateTransformationBetaInput {
    ...
    public CreateTransformationBetaInput addPropertyRenamesItem(
    ...
    public boolean equals(Object o) {
        ...
        CreateTransformationBetaInput createTransformationBetaInput =
                (CreateTransformationBetaInput) o;
        return Objects.equals(this.name, createTransformationBetaInput.name)
                ...
                && Objects.equals(
                        ...
                        createTransformationBetaInput.destinationMetadataId)
            ...
            if (!CreateTransformationBetaInput.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                ...
                                CreateTransformationBetaInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateTransformationBetaInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateTransformationBetaInput' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateTransformationBetaInput> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreateTransformationBetaInput.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreateTransformationBetaInput>() {
                        @Override
                        public void write(JsonWriter out, CreateTransformationBetaInput value)
                                throws IOException {
