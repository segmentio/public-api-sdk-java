...
public class CreateTransformationBetaInput {
  ...
  **/
  ...
  public CreateTransformationBetaInput sourceId(String sourceId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The Source to be associated with the Transformation.")
  ...
  public CreateTransformationBetaInput destinationMetadataId(String destinationMetadataId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The optional Destination metadata id to be associated with the Transformation.")
  ...
  public CreateTransformationBetaInput enabled(Boolean enabled) {
  ...
  **/
  ...
  public CreateTransformationBetaInput _if(String _if) {
  ...
  **/
  ...
  public CreateTransformationBetaInput newEventName(String newEventName) {
  ...
  **/
  ...
  public CreateTransformationBetaInput propertyRenames(List<PropertyRenameBeta> propertyRenames) {
    
    this.propertyRenames = propertyRenames;
    return this;
  }

  public CreateTransformationBetaInput addPropertyRenamesItem(PropertyRenameBeta propertyRenamesItem) {
  ...
  **/
  ...
  public CreateTransformationBetaInput propertyValueTransformations(List<PropertyValueTransformationBeta> propertyValueTransformations) {
    
    this.propertyValueTransformations = propertyValueTransformations;
    return this;
  }

  public CreateTransformationBetaInput addPropertyValueTransformationsItem(PropertyValueTransformationBeta propertyValueTransformationsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateTransformationBetaInput createTransformationBetaInput = (CreateTransformationBetaInput) o;
    return Objects.equals(this.name, createTransformationBetaInput.name) &&
        Objects.equals(this.sourceId, createTransformationBetaInput.sourceId) &&
        Objects.equals(this.destinationMetadataId, createTransformationBetaInput.destinationMetadataId) &&
        Objects.equals(this.enabled, createTransformationBetaInput.enabled) &&
        ...
        Objects.equals(this.propertyRenames, createTransformationBetaInput.propertyRenames) &&
        Objects.equals(this.propertyValueTransformations, createTransformationBetaInput.propertyValueTransformations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, sourceId, destinationMetadataId, enabled, _if, newEventName, propertyRenames, propertyValueTransformations);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateTransformationBetaInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateTransformationBetaInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTransformationBetaInput is not found in the empty JSON string", CreateTransformationBetaInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateTransformationBetaInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTransformationBetaInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTransformationBetaInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTransformationBetaInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTransformationBetaInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTransformationBetaInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTransformationBetaInput>() {
           @Override
           public void write(JsonWriter out, CreateTransformationBetaInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTransformationBetaInput read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateTransformationBetaInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateTransformationBetaInput
  * @throws IOException if the JSON string is invalid with respect to CreateTransformationBetaInput
  */
  public static CreateTransformationBetaInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTransformationBetaInput.class);
  }

 /**
  * Convert an instance of CreateTransformationBetaInput to an JSON string
  *
  * @return JSON string
  */
