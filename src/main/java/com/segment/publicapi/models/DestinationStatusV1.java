...
public class DestinationStatusV1 {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DestinationStatusV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationStatusV1 is not found in the empty JSON string", DestinationStatusV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DestinationStatusV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationStatusV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (!jsonObj.get("errString").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `errString` to be a primitive type in the JSON string but got `%s`", jsonObj.get("errString").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DestinationStatusV1>() {
           @Override
           public void write(JsonWriter out, DestinationStatusV1 value) throws IOException {
