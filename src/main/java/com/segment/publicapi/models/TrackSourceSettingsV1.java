...
public class TrackSourceSettingsV1 {
  ...
  **/
  ...
  public TrackSourceSettingsV1 allowUnplannedEventProperties(Boolean allowUnplannedEventProperties) {
  ...
  **/
  ...
  public TrackSourceSettingsV1 commonEventOnViolations(CommonEventOnViolationsEnum commonEventOnViolations) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowUnplannedEvents, trackSourceSettingsV1.allowUnplannedEvents) &&
        Objects.equals(this.allowUnplannedEventProperties, trackSourceSettingsV1.allowUnplannedEventProperties) &&
        Objects.equals(this.allowEventOnViolations, trackSourceSettingsV1.allowEventOnViolations) &&
        Objects.equals(this.allowPropertiesOnViolations, trackSourceSettingsV1.allowPropertiesOnViolations) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TrackSourceSettingsV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackSourceSettingsV1 is not found in the empty JSON string", TrackSourceSettingsV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TrackSourceSettingsV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackSourceSettingsV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TrackSourceSettingsV1>() {
           @Override
           public void write(JsonWriter out, TrackSourceSettingsV1 value) throws IOException {
