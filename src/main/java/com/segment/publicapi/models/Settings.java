...
public class Settings {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.track, settings.track)
                ...
                && Objects.equals(
                        this.forwardingBlockedEventsTo, settings.forwardingBlockedEventsTo);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Settings.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Settings is not found in the empty"
                                        + " JSON string",
                                Settings.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Settings.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `Settings`"
                                        + " properties. JSON: %s",
