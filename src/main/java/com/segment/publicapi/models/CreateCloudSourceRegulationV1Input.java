...
public class CreateCloudSourceRegulationV1Input {
    ...
    public boolean equals(Object o) {
        ...
        CreateCloudSourceRegulationV1Input createCloudSourceRegulationV1Input =
                (CreateCloudSourceRegulationV1Input) o;
        return Objects.equals(
                        this.regulationType, createCloudSourceRegulationV1Input.regulationType)
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!CreateCloudSourceRegulationV1Input.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateCloudSourceRegulationV1Input is"
                                        + " not found in the empty JSON string",
                                CreateCloudSourceRegulationV1Input.openapiRequiredFields
                                        .toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `CreateCloudSourceRegulationV1Input` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCloudSourceRegulationV1Input.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCloudSourceRegulationV1Input' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateCloudSourceRegulationV1Input> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreateCloudSourceRegulationV1Input.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreateCloudSourceRegulationV1Input>() {
                        @Override
                        public void write(JsonWriter out, CreateCloudSourceRegulationV1Input value)
                                throws IOException {
                        ...
                        @Override
                        public CreateCloudSourceRegulationV1Input read(JsonReader in)
                                throws IOException {
     ...
     *     CreateCloudSourceRegulationV1Input
     */
    public static CreateCloudSourceRegulationV1Input fromJson(String jsonString)
            throws IOException {
