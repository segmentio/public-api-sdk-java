 ...
 */
@ApiModel(description = "The updated Function object.")
...
public class Function2 {
  ...
  **/
  ...
  public Function2 resourceType(ResourceTypeEnum resourceType) {
  ...
  **/
  ...
  public Function2 createdAt(String createdAt) {
  ...
  **/
  ...
  public Function2 createdBy(String createdBy) {
  ...
  **/
  ...
  public Function2 code(String code) {
  ...
  **/
  ...
  public Function2 deployedAt(String deployedAt) {
  ...
  **/
  ...
  public Function2 settings(List<FunctionSettingV1> settings) {
    
    this.settings = settings;
    return this;
  }

  public Function2 addSettingsItem(FunctionSettingV1 settingsItem) {
  ...
  **/
  ...
  public Function2 displayName(String displayName) {
  ...
  **/
  ...
  public Function2 description(String description) {
  ...
  **/
  ...
  public Function2 logoUrl(String logoUrl) {
  ...
  **/
  ...
  public Function2 previewWebhookUrl(String previewWebhookUrl) {
  ...
  **/
  ...
  public Function2 batchMaxCount(BigDecimal batchMaxCount) {
  ...
  **/
  ...
  public Function2 catalogId(String catalogId) {
  ...
  **/
  ...
  public Function2 isLatestVersion(Boolean isLatestVersion) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, function2.id) &&
        Objects.equals(this.resourceType, function2.resourceType) &&
        Objects.equals(this.createdAt, function2.createdAt) &&
        Objects.equals(this.createdBy, function2.createdBy) &&
        Objects.equals(this.code, function2.code) &&
        Objects.equals(this.deployedAt, function2.deployedAt) &&
        Objects.equals(this.settings, function2.settings) &&
        Objects.equals(this.displayName, function2.displayName) &&
        Objects.equals(this.description, function2.description) &&
        Objects.equals(this.logoUrl, function2.logoUrl) &&
        Objects.equals(this.previewWebhookUrl, function2.previewWebhookUrl) &&
        Objects.equals(this.batchMaxCount, function2.batchMaxCount) &&
        Objects.equals(this.catalogId, function2.catalogId) &&
        Objects.equals(this.isLatestVersion, function2.isLatestVersion);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Function2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Function2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Function2 is not found in the empty JSON string", Function2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Function2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Function2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Function2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Function2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Function2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Function2.class));

       return (TypeAdapter<T>) new TypeAdapter<Function2>() {
           @Override
           public void write(JsonWriter out, Function2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Function2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Function2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Function2
  * @throws IOException if the JSON string is invalid with respect to Function2
  */
  public static Function2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Function2.class);
  }

 /**
  * Convert an instance of Function2 to an JSON string
  *
  * @return JSON string
  */
