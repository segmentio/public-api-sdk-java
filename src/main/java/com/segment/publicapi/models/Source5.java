 ...
 */
@ApiModel(description = "The newly created Source.")
...
public class Source5 {
  ...
  **/
  ...
  public Source5 slug(String slug) {
  ...
  **/
  ...
  public Source5 name(String name) {
  ...
  **/
  ...
  public Source5 metadata(Metadata1 metadata) {
  ...
  **/
  ...
  public Source5 workspaceId(String workspaceId) {
  ...
  **/
  ...
  public Source5 enabled(Boolean enabled) {
  ...
  **/
  ...
  public Source5 writeKeys(List<String> writeKeys) {
    
    this.writeKeys = writeKeys;
    return this;
  }

  public Source5 addWriteKeysItem(String writeKeysItem) {
  ...
  **/
  ...
  public Source5 settings(Map settings) {
  ...
  **/
  ...
  public Source5 labels(List<LabelV1> labels) {
    
    this.labels = labels;
    return this;
  }

  public Source5 addLabelsItem(LabelV1 labelsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Source5 source5 = (Source5) o;
    return Objects.equals(this.id, source5.id) &&
        Objects.equals(this.slug, source5.slug) &&
        Objects.equals(this.name, source5.name) &&
        Objects.equals(this.metadata, source5.metadata) &&
        Objects.equals(this.workspaceId, source5.workspaceId) &&
        Objects.equals(this.enabled, source5.enabled) &&
        Objects.equals(this.writeKeys, source5.writeKeys) &&
        Objects.equals(this.settings, source5.settings) &&
        Objects.equals(this.labels, source5.labels);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Source5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Source5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Source5 is not found in the empty JSON string", Source5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Source5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Source5` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Source5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Source5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Source5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Source5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Source5.class));

       return (TypeAdapter<T>) new TypeAdapter<Source5>() {
           @Override
           public void write(JsonWriter out, Source5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Source5 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Source5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Source5
  * @throws IOException if the JSON string is invalid with respect to Source5
  */
  public static Source5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Source5.class);
  }

 /**
  * Convert an instance of Source5 to an JSON string
  *
  * @return JSON string
  */
