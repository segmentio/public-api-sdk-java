...
public class DestinationMetadata {
    ...
    public DestinationMetadata options(List<IntegrationOptionBeta> options) {
    ...
    public DestinationMetadata previousNames(List<String> previousNames) {
    ...
    public DestinationMetadata categories(List<String> categories) {
    ...
    public DestinationMetadata components(List<DestinationMetadataComponentV1> components) {
    ...
    public DestinationMetadata actions(List<DestinationMetadataActionV1> actions) {
    ...
    public DestinationMetadata presets(List<DestinationMetadataSubscriptionPresetV1> presets) {
    ...
    public DestinationMetadata contacts(List<Contact> contacts) {
    ...
    public DestinationMetadata supportedRegions(List<String> supportedRegions) {

        this.supportedRegions = supportedRegions;
        return this;
    }

    public DestinationMetadata addSupportedRegionsItem(String supportedRegionsItem) {
    ...
    public DestinationMetadata regionEndpoints(List<String> regionEndpoints) {

        this.regionEndpoints = regionEndpoints;
        return this;
    }

    public DestinationMetadata addRegionEndpointsItem(String regionEndpointsItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, destinationMetadata.id)
                ...
                && Objects.equals(this.supportedRegions, destinationMetadata.supportedRegions)
                && Objects.equals(this.regionEndpoints, destinationMetadata.regionEndpoints);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!DestinationMetadata.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DestinationMetadata is not found in"
                                        + " the empty JSON string",
                                DestinationMetadata.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `DestinationMetadata` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<DestinationMetadata> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(DestinationMetadata.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<DestinationMetadata>() {
                        @Override
                        public void write(JsonWriter out, DestinationMetadata value)
                                throws IOException {
