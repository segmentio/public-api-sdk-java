...
public class GetDeliveryOverviewSourceMetricsBetaInput {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput() {}

    public GetDeliveryOverviewSourceMetricsBetaInput sourceId(String sourceId) {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput destinationConfigId(
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput startTime(String startTime) {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput endTime(String endTime) {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput groupBy(List<String> groupBy) {

        this.groupBy = groupBy;
        return this;
    }

    public GetDeliveryOverviewSourceMetricsBetaInput addGroupByItem(String groupByItem) {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput granularity(GranularityEnum granularity) {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput filter(DeliveryOverviewFilterBy filter) {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput pagination(PaginationInput pagination) {
    ...
    public GetDeliveryOverviewSourceMetricsBetaInput subscriptionId(String subscriptionId) {
    ...
    public boolean equals(Object o) {
        ...
        GetDeliveryOverviewSourceMetricsBetaInput getDeliveryOverviewSourceMetricsBetaInput =
                (GetDeliveryOverviewSourceMetricsBetaInput) o;
        return Objects.equals(this.sourceId, getDeliveryOverviewSourceMetricsBetaInput.sourceId)
                && Objects.equals(
                        this.destinationConfigId,
                        getDeliveryOverviewSourceMetricsBetaInput.destinationConfigId)
                && Objects.equals(
                        this.startTime, getDeliveryOverviewSourceMetricsBetaInput.startTime)
                && Objects.equals(this.endTime, getDeliveryOverviewSourceMetricsBetaInput.endTime)
                && Objects.equals(this.groupBy, getDeliveryOverviewSourceMetricsBetaInput.groupBy)
                && Objects.equals(
                        this.granularity, getDeliveryOverviewSourceMetricsBetaInput.granularity)
                && Objects.equals(this.filter, getDeliveryOverviewSourceMetricsBetaInput.filter)
                && Objects.equals(
                        this.pagination, getDeliveryOverviewSourceMetricsBetaInput.pagination)
                && Objects.equals(
                        this.subscriptionId,
                        getDeliveryOverviewSourceMetricsBetaInput.subscriptionId);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetDeliveryOverviewSourceMetricsBetaInput {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetDeliveryOverviewSourceMetricsBetaInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetDeliveryOverviewSourceMetricsBetaInput is not found in"
                                    + " the empty JSON string",
                                GetDeliveryOverviewSourceMetricsBetaInput.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetDeliveryOverviewSourceMetricsBetaInput.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `GetDeliveryOverviewSourceMetricsBetaInput` properties."
                                        + " JSON: %s",
        ...
        if ((jsonObj.get("destinationConfigId") != null
                        && !jsonObj.get("destinationConfigId").isJsonNull())
                && !jsonObj.get("destinationConfigId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetDeliveryOverviewSourceMetricsBetaInput.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetDeliveryOverviewSourceMetricsBetaInput' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetDeliveryOverviewSourceMetricsBetaInput> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetDeliveryOverviewSourceMetricsBetaInput.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetDeliveryOverviewSourceMetricsBetaInput>() {
                        @Override
                        public void write(
                                JsonWriter out, GetDeliveryOverviewSourceMetricsBetaInput value)
                                throws IOException {
                        ...
                        @Override
                        public GetDeliveryOverviewSourceMetricsBetaInput read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetDeliveryOverviewSourceMetricsBetaInput given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetDeliveryOverviewSourceMetricsBetaInput
     * @throws IOException if the JSON string is invalid with respect to
     *     GetDeliveryOverviewSourceMetricsBetaInput
     */
    public static GetDeliveryOverviewSourceMetricsBetaInput fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetDeliveryOverviewSourceMetricsBetaInput.class);
    }

    /**
     * Convert an instance of GetDeliveryOverviewSourceMetricsBetaInput to an JSON string
     *
     * @return JSON string
     */
