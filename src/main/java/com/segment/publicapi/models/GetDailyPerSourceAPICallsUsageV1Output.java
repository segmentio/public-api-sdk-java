...
public class GetDailyPerSourceAPICallsUsageV1Output {
    ...
    public GetDailyPerSourceAPICallsUsageV1Output dailyPerSourceAPICallsUsage(
            List<SourceAPICallSnapshotV1> dailyPerSourceAPICallsUsage) {
    ...
    public void setDailyPerSourceAPICallsUsage(
            List<SourceAPICallSnapshotV1> dailyPerSourceAPICallsUsage) {
        this.dailyPerSourceAPICallsUsage = dailyPerSourceAPICallsUsage;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetDailyPerSourceAPICallsUsageV1Output getDailyPerSourceAPICallsUsageV1Output =
                (GetDailyPerSourceAPICallsUsageV1Output) o;
        return Objects.equals(
                        this.dailyPerSourceAPICallsUsage,
                        getDailyPerSourceAPICallsUsageV1Output.dailyPerSourceAPICallsUsage)
                && Objects.equals(
                        this.pagination, getDailyPerSourceAPICallsUsageV1Output.pagination);
    }
    ...
    public String toString() {
        ...
        sb.append("    dailyPerSourceAPICallsUsage: ")
                .append(toIndentedString(dailyPerSourceAPICallsUsage))
                .append("\n");
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetDailyPerSourceAPICallsUsageV1Output.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetDailyPerSourceAPICallsUsageV1Output'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetDailyPerSourceAPICallsUsageV1Output> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetDailyPerSourceAPICallsUsageV1Output.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetDailyPerSourceAPICallsUsageV1Output>() {
                        @Override
                        public void write(
                                JsonWriter out, GetDailyPerSourceAPICallsUsageV1Output value)
                                throws IOException {
     ...
     *     GetDailyPerSourceAPICallsUsageV1Output
     */
    public static GetDailyPerSourceAPICallsUsageV1Output fromJson(String jsonString)
            throws IOException {
