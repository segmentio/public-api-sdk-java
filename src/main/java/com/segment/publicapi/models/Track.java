...
public class Track {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.allowUnplannedEvents, track.allowUnplannedEvents)
                && Objects.equals(
                        this.allowUnplannedEventProperties, track.allowUnplannedEventProperties)
                && Objects.equals(this.allowEventOnViolations, track.allowEventOnViolations)
                && Objects.equals(
                        this.allowPropertiesOnViolations, track.allowPropertiesOnViolations)
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Track.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Track is not found in the empty JSON"
                                        + " string",
                                Track.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Track.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `Track`"
                                        + " properties. JSON: %s",
