...
@ApiModel(description = "The retrieved Transformation.")
public class Transformation3 {
    ...
    public Transformation3 id(String id) {
    ...
    public Transformation3 name(String name) {
    ...
    public Transformation3 sourceId(String sourceId) {
    ...
    public Transformation3 destinationMetadataId(String destinationMetadataId) {
    ...
    public Transformation3 enabled(Boolean enabled) {
    ...
    public Transformation3 _if(String _if) {
    ...
    public Transformation3 newEventName(String newEventName) {
    ...
    public Transformation3 propertyRenames(List<PropertyRenameV1> propertyRenames) {

        this.propertyRenames = propertyRenames;
        return this;
    }

    public Transformation3 addPropertyRenamesItem(PropertyRenameV1 propertyRenamesItem) {
    ...
    public Transformation3 propertyValueTransformations(
    ...
    public Transformation3 addPropertyValueTransformationsItem(
    ...
    public Transformation3 fqlDefinedProperties(List<FQLDefinedPropertyV1> fqlDefinedProperties) {

        this.fqlDefinedProperties = fqlDefinedProperties;
        return this;
    }

    public Transformation3 addFqlDefinedPropertiesItem(
    ...
    @ApiModelProperty(
            value =
                    "Optional array for defining new properties in FQL. Limited to 1 property right"
                            + " now.")
    ...
    public boolean equals(Object o) {
        ...
        Transformation3 transformation3 = (Transformation3) o;
        return Objects.equals(this.id, transformation3.id)
                && Objects.equals(this.name, transformation3.name)
                && Objects.equals(this.sourceId, transformation3.sourceId)
                && Objects.equals(this.destinationMetadataId, transformation3.destinationMetadataId)
                && Objects.equals(this.enabled, transformation3.enabled)
                && Objects.equals(this._if, transformation3._if)
                && Objects.equals(this.newEventName, transformation3.newEventName)
                && Objects.equals(this.propertyRenames, transformation3.propertyRenames)
                && Objects.equals(
                        this.propertyValueTransformations,
                        transformation3.propertyValueTransformations)
                && Objects.equals(this.fqlDefinedProperties, transformation3.fqlDefinedProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("class Transformation3 {\n");
     ...
     * @throws IOException if the JSON Object is invalid with respect to Transformation3
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Transformation3.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Transformation3 is not found in the"
                                        + " empty JSON string",
                                Transformation3.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Transformation3.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Transformation3` properties. JSON: %s",
                                entry.getKey(), jsonObj.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : Transformation3.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Transformation3.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Transformation3' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Transformation3> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(Transformation3.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<Transformation3>() {
                        @Override
                        public void write(JsonWriter out, Transformation3 value)
                                throws IOException {
                        ...
                        @Override
                        public Transformation3 read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of Transformation3 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Transformation3
     * @throws IOException if the JSON string is invalid with respect to Transformation3
     */
    public static Transformation3 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Transformation3.class);
    }

    /**
     * Convert an instance of Transformation3 to an JSON string
     *
     * @return JSON string
     */
