...
public class ListFunctionItemV1 {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, resourceType, createdAt, createdBy, displayName, description, logoUrl, catalogId);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListFunctionItemV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFunctionItemV1 is not found in the empty JSON string", ListFunctionItemV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListFunctionItemV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFunctionItemV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListFunctionItemV1>() {
           @Override
           public void write(JsonWriter out, ListFunctionItemV1 value) throws IOException {
