...
public class WarehouseAdvancedSyncV1 {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The hour of day for which to enable/disable a sync, between 0 and 23.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WarehouseAdvancedSyncV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WarehouseAdvancedSyncV1 is not found in the empty JSON string", WarehouseAdvancedSyncV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WarehouseAdvancedSyncV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WarehouseAdvancedSyncV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WarehouseAdvancedSyncV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WarehouseAdvancedSyncV1' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<WarehouseAdvancedSyncV1>() {
           @Override
           public void write(JsonWriter out, WarehouseAdvancedSyncV1 value) throws IOException {
