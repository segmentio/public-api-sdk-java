...
public class Transformation4 {
    ...
    public Transformation4 id(String id) {
    ...
    public Transformation4 name(String name) {
    ...
    public Transformation4 sourceId(String sourceId) {
    ...
    public Transformation4 destinationMetadataId(String destinationMetadataId) {
    ...
    public Transformation4 enabled(Boolean enabled) {
    ...
    public Transformation4 _if(String _if) {
    ...
    public Transformation4 newEventName(String newEventName) {
    ...
    public Transformation4 propertyRenames(List<PropertyRenameV1> propertyRenames) {

        this.propertyRenames = propertyRenames;
        return this;
    }

    public Transformation4 addPropertyRenamesItem(PropertyRenameV1 propertyRenamesItem) {
    ...
    public Transformation4 propertyValueTransformations(
    ...
    public Transformation4 addPropertyValueTransformationsItem(
    ...
    public Transformation4 fqlDefinedProperties(List<FQLDefinedPropertyV1> fqlDefinedProperties) {

        this.fqlDefinedProperties = fqlDefinedProperties;
        return this;
    }

    public Transformation4 addFqlDefinedPropertiesItem(
    ...
    public boolean equals(Object o) {
        ...
        Transformation4 transformation4 = (Transformation4) o;
        return Objects.equals(this.id, transformation4.id)
                && Objects.equals(this.name, transformation4.name)
                && Objects.equals(this.sourceId, transformation4.sourceId)
                && Objects.equals(this.destinationMetadataId, transformation4.destinationMetadataId)
                && Objects.equals(this.enabled, transformation4.enabled)
                && Objects.equals(this._if, transformation4._if)
                && Objects.equals(this.newEventName, transformation4.newEventName)
                && Objects.equals(this.propertyRenames, transformation4.propertyRenames)
                && Objects.equals(
                        this.propertyValueTransformations,
                        transformation4.propertyValueTransformations)
                && Objects.equals(this.fqlDefinedProperties, transformation4.fqlDefinedProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("class Transformation4 {\n");
     ...
     * @throws IOException if the JSON Object is invalid with respect to Transformation4
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Transformation4.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Transformation4 is not found in the"
                                        + " empty JSON string",
                                Transformation4.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Transformation4.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Transformation4` properties. JSON: %s",
                                entry.getKey(), jsonObj.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : Transformation4.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Transformation4.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Transformation4' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Transformation4> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(Transformation4.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<Transformation4>() {
                        @Override
                        public void write(JsonWriter out, Transformation4 value)
                                throws IOException {
                        ...
                        @Override
                        public Transformation4 read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of Transformation4 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Transformation4
     * @throws IOException if the JSON string is invalid with respect to Transformation4
     */
    public static Transformation4 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Transformation4.class);
    }

    /**
     * Convert an instance of Transformation4 to an JSON string
     *
     * @return JSON string
     */
