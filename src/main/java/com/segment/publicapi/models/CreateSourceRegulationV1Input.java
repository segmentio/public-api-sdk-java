 ...
 */
@ApiModel(description = "The input to create a Source-scoped regulation.")
...
public class CreateSourceRegulationV1Input {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateSourceRegulationV1Input createSourceRegulationV1Input = (CreateSourceRegulationV1Input) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSourceRegulationV1Input
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateSourceRegulationV1Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSourceRegulationV1Input is not found in the empty JSON string", CreateSourceRegulationV1Input.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateSourceRegulationV1Input.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSourceRegulationV1Input` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSourceRegulationV1Input.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSourceRegulationV1Input' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSourceRegulationV1Input> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSourceRegulationV1Input.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSourceRegulationV1Input>() {
           @Override
           public void write(JsonWriter out, CreateSourceRegulationV1Input value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSourceRegulationV1Input read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateSourceRegulationV1Input
  */
