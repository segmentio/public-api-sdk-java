...
public class DestinationSubscriptionUpdateInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DestinationSubscriptionUpdateInput destinationSubscriptionUpdateInput = (DestinationSubscriptionUpdateInput) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to DestinationSubscriptionUpdateInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DestinationSubscriptionUpdateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationSubscriptionUpdateInput is not found in the empty JSON string", DestinationSubscriptionUpdateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DestinationSubscriptionUpdateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationSubscriptionUpdateInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinationSubscriptionUpdateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinationSubscriptionUpdateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinationSubscriptionUpdateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinationSubscriptionUpdateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinationSubscriptionUpdateInput>() {
           @Override
           public void write(JsonWriter out, DestinationSubscriptionUpdateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinationSubscriptionUpdateInput read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to DestinationSubscriptionUpdateInput
  */
  public static DestinationSubscriptionUpdateInput fromJson(String jsonString) throws IOException {
