...
import com.segment.publicapi.models.Source2;
 ...
 */
@ApiModel(description = "Returns the newly Source.")
...
public class CreateSourceAlphaOutput {
  ...
  public CreateSourceAlphaOutput source(Source2 source) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSourceAlphaOutput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateSourceAlphaOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSourceAlphaOutput is not found in the empty JSON string", CreateSourceAlphaOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateSourceAlphaOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSourceAlphaOutput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSourceAlphaOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSourceAlphaOutput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateSourceAlphaOutput>() {
           @Override
           public void write(JsonWriter out, CreateSourceAlphaOutput value) throws IOException {
