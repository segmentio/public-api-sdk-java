...
import com.segment.publicapi.models.Regulation;
 ...
 */
@ApiModel(description = "The regulate request returned.")
...
public class GetRegulationV1Output {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetRegulationV1Output
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetRegulationV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRegulationV1Output is not found in the empty JSON string", GetRegulationV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetRegulationV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRegulationV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetRegulationV1Output>() {
           @Override
           public void write(JsonWriter out, GetRegulationV1Output value) throws IOException {
