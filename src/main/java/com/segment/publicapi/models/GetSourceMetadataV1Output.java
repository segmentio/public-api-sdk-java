...
public class GetSourceMetadataV1Output {
    ...
    private SourceMetadataV1 sourceMetadata;

    public GetSourceMetadataV1Output() {}

    public GetSourceMetadataV1Output sourceMetadata(SourceMetadataV1 sourceMetadata) {
    ...
    public SourceMetadataV1 getSourceMetadata() {
        return sourceMetadata;
    }

    public void setSourceMetadata(SourceMetadataV1 sourceMetadata) {
        this.sourceMetadata = sourceMetadata;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetSourceMetadataV1Output
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the required field `sourceMetadata`
        SourceMetadataV1.validateJsonElement(jsonObj.get("sourceMetadata"));
    }
