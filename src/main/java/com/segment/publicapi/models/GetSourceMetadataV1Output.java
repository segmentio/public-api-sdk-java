...
import com.segment.publicapi.models.SourceMetadata;
...
public class GetSourceMetadataV1Output {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetSourceMetadataV1Output.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSourceMetadataV1Output is not found in the empty JSON string", GetSourceMetadataV1Output.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetSourceMetadataV1Output.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSourceMetadataV1Output` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSourceMetadataV1Output.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSourceMetadataV1Output' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetSourceMetadataV1Output>() {
           @Override
           public void write(JsonWriter out, GetSourceMetadataV1Output value) throws IOException {
