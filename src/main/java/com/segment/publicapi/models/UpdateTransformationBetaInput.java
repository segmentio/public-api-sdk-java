...
public class UpdateTransformationBetaInput {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If statement ([FQL](https://segment.com/docs/config-api/fql/)) to match events.  For standard event matchers, use the following:   Track -\\> \"event='\\<eventName\\>'\"   Identify -\\> \"type='identify'\"   Group -\\> \"type='group'\"")
  ...
  **/
  ...
  public UpdateTransformationBetaInput propertyValueTransformations(List<PropertyValueTransformationBeta> propertyValueTransformations) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateTransformationBetaInput.name) &&
        ...
        Objects.equals(this.propertyValueTransformations, updateTransformationBetaInput.propertyValueTransformations);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateTransformationBetaInput>() {
           @Override
