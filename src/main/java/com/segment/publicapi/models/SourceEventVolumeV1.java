 ...
 */
@ApiModel(description = "SourceEventVolume represents a time series of event volume for a Workspace broken down by the dimensions which the customer specifies (optional parameters).")
...
public class SourceEventVolumeV1 {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The total count for all events in the requested time frame.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of the event counts broken down by the requested granularity.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SourceEventVolumeV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceEventVolumeV1 is not found in the empty JSON string", SourceEventVolumeV1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SourceEventVolumeV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceEventVolumeV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SourceEventVolumeV1>() {
           @Override
           public void write(JsonWriter out, SourceEventVolumeV1 value) throws IOException {
