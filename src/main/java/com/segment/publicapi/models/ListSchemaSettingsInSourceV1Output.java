...
public class ListSchemaSettingsInSourceV1Output {
    ...
    public boolean equals(Object o) {
        ...
        ListSchemaSettingsInSourceV1Output listSchemaSettingsInSourceV1Output =
                (ListSchemaSettingsInSourceV1Output) o;
            ...
            if (!ListSchemaSettingsInSourceV1Output.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                ...
                                ListSchemaSettingsInSourceV1Output.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListSchemaSettingsInSourceV1Output.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListSchemaSettingsInSourceV1Output' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ListSchemaSettingsInSourceV1Output> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ListSchemaSettingsInSourceV1Output.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ListSchemaSettingsInSourceV1Output>() {
                        @Override
                        public void write(JsonWriter out, ListSchemaSettingsInSourceV1Output value)
                                throws IOException {
     ...
     *     ListSchemaSettingsInSourceV1Output
     */
    public static ListSchemaSettingsInSourceV1Output fromJson(String jsonString)
            throws IOException {
