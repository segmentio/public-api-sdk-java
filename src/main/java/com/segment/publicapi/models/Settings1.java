...
public class Settings1 {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.track, settings1.track)
                ...
                && Objects.equals(
                        this.forwardingBlockedEventsTo, settings1.forwardingBlockedEventsTo);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!Settings1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Settings1 is not found in the empty"
                                        + " JSON string",
                                Settings1.openapiRequiredFields.toString()));
            }
        }
