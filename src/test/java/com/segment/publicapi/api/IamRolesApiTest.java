...
/**
 * API tests for IamRolesApi
 */
@Disabled
public class IamRolesApiTest {

    private final IamRolesApi api = new IamRolesApi();
    ...
    public void listRolesTest() throws ApiException {
        ...
        ListRoles200Response response = api.listRoles(pagination);
