...
| **regulationTypes** | [**List&lt;String&gt;**](String.md)| The regulation types on which to filter returned regulations.  This parameter exists in v1. | [optional] [enum: DELETE_INTERNAL, DELETE_ONLY, SUPPRESS_ONLY, SUPPRESS_WITH_DELETE, UNSUPPRESS] |
